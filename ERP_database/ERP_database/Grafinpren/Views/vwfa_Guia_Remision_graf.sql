...
SELECT        dbo.fa_guia_remision.IdEmpresa, dbo.fa_guia_remision.IdSucursal, dbo.fa_guia_remision.IdBodega, dbo.fa_guia_remision.IdGuiaRemision, 
                         ...
                         dbo.fa_guia_remision.gi_TotalKilos, dbo.fa_guia_remision.gi_TotalQuintales, dbo.fa_guia_remision.Estado, dbo.fa_guia_remision.IdPeriodo, 
                         dbo.fa_guia_remision.gi_FechaFinTraslado, dbo.fa_guia_remision.gi_FechaIniTraslado, Grafinpren.fa_guia_remision_graf.Num_OP, 
                         ...
                         dbo.fa_guia_remision.IdVendedor, dbo.fa_guia_remision.IdTransportista, dbo.tb_persona.pe_razonSocial, Grafinpren.fa_guia_remision_graf.IdEquipo, 
                         ...
                         dbo.fa_guia_remision.Direccion_Origen, dbo.fa_guia_remision.Direccion_Destino, dbo.tb_empresa.em_nombre, dbo.tb_empresa.RazonSocial, 
                         ...
                         dbo.tb_persona.pe_direccion, dbo.tb_persona.pe_telefonoCasa, dbo.tb_persona.pe_telefonoOfic, dbo.tb_persona.pe_celular, dbo.tb_persona.pe_correo, 
                         dbo.tb_persona.pe_Naturaleza, dbo.tb_persona.pe_nombreCompleto, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.tb_persona.IdTipoPersona
