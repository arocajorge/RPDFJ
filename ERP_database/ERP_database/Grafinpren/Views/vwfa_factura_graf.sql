...
SELECT        dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, dbo.fa_factura.IdSucursal, dbo.fa_factura.CodCbteVta, dbo.fa_factura.vt_tipoDoc, 
                         ...
                         dbo.fa_factura.vt_mes, dbo.fa_factura.vt_flete, dbo.fa_factura.vt_interes, dbo.fa_factura.vt_OtroValor1, dbo.fa_factura.vt_OtroValor2, dbo.fa_factura.IdUsuario, 
                         ...
                         dbo.fa_factura.MotivoAnulacion, dbo.fa_factura.nom_pc, dbo.fa_factura.ip, dbo.fa_factura.Estado, dbo.tb_sucursal.Su_Descripcion, dbo.tb_bodega.bo_Descripcion, 
                         ...
                         dbo.fa_factura.vt_autorizacion, dbo.tb_persona.IdTipoDocumento, dbo.tb_persona.pe_cedulaRuc, dbo.fa_factura.IdCaja, dbo.fa_factura.IdEmpresa_nc_anu, 
                         dbo.fa_factura.IdSucursal_nc_anu, dbo.fa_factura.IdBodega_nc_anu, dbo.fa_factura.IdNota_nc_anu, dbo.fa_factura.vt_seguro, dbo.fa_factura_det.vt_Peso, 
