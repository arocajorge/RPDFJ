CREATE TABLE [dbo].[ro_parametro_contable_x_Nomina_Tipoliqui_Sueldo_x_Pagar] (
    ...
    CONSTRAINT [FK_ro_parametro_contable_x_Nomina_Tipoliqui_Sueldo_x_Pagar_ba_TipoFlujo] FOREIGN KEY ([IdEmpresa], [IdTipoFlujo]) REFERENCES [dbo].[ba_TipoFlujo] ([IdEmpresa], [IdTipoFlujo]),
    CONSTRAINT [FK_ro_parametro_contable_x_Nomina_Tipoliqui_Sueldo_x_Pagar_ct_plancta] FOREIGN KEY ([IdEmpresa], [IdCtaCble]) REFERENCES [dbo].[ct_plancta] ([IdEmpresa], [IdCtaCble]),
