CREATE TABLE [dbo].[Af_Activo_fijo_Categoria] (
    ...
    CONSTRAINT [FK_Af_Activo_fijo_Categoria_Af_Activo_fijo_tipo] FOREIGN KEY ([IdEmpresa], [IdActivoFijoTipo]) REFERENCES [dbo].[Af_Activo_fijo_tipo] ([IdEmpresa], [IdActijoFijoTipo])
);
