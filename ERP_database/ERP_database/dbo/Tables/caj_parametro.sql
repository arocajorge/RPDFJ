CREATE TABLE [dbo].[caj_parametro] (
    ...
    [IdTipoCbteCble_MoviCaja_Ing_Anu] INT          NOT NULL,
    [IdTipoCbteCble_MoviCaja_Egr_Anu] INT          NOT NULL,
    ...
    CONSTRAINT [FK_caj_parametro_ct_cbtecble_tipo2] FOREIGN KEY ([IdEmpresa], [IdTipoCbteCble_MoviCaja_Ing_Anu]) REFERENCES [dbo].[ct_cbtecble_tipo] ([IdEmpresa], [IdTipoCbte]),
    CONSTRAINT [FK_caj_parametro_ct_cbtecble_tipo3] FOREIGN KEY ([IdEmpresa], [IdTipoCbteCble_MoviCaja_Egr_Anu]) REFERENCES [dbo].[ct_cbtecble_tipo] ([IdEmpresa], [IdTipoCbte]),
