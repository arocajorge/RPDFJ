CREATE TABLE [dbo].[tb_persona] (
    ...
    [pe_telefonoCasa]            VARCHAR (50)  NULL,
    [pe_telefonoOfic]            VARCHAR (50)  NULL,
    ...
    [IdEstadoCivil]              VARCHAR (25)  NOT NULL,
    ...
    [pe_celularSecundario]       VARCHAR (50)  NULL,
    [IdUsuarioUltAnu]            VARCHAR (20)  NULL,
    [Fecha_UltAnu]               DATETIME      NULL,
    [MotivoAnulacion]            VARCHAR (100) NULL,
    [pe_correo_secundario1]      VARCHAR (100) NULL,
    [pe_correo_secundario2]      VARCHAR (100) NULL,
