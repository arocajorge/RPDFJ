CREATE TABLE [dbo].[ro_empleado] (
    ...
    [em_SeAcreditaBanco]                   VARCHAR (1)     NOT NULL,
    [em_tipoCta]                           VARCHAR (25)    NOT NULL,
    [em_NumCta]                            VARCHAR (20)    NOT NULL,
    [em_SepagaBeneficios]                  VARCHAR (1)     NOT NULL,
    [em_SePagaConTablaSec]                 VARCHAR (1)     NOT NULL,
    ...
    [recibi_uniforme]                      CHAR (1)        NOT NULL,
    [talla_pant]                           FLOAT (53)      NOT NULL,
    [talla_camisa]                         VARCHAR (50)    NOT NULL,
    [talla_zapato]                         FLOAT (53)      NOT NULL,
