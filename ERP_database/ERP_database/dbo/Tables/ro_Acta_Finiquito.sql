CREATE TABLE [dbo].[ro_Acta_Finiquito] (
    ...
    CONSTRAINT [PK_ro_Acta_Finiquito] PRIMARY KEY CLUSTERED ([IdEmpresa] ASC, [IdActaFiniquito] ASC, [IdEmpleado] ASC),
    CONSTRAINT [FK_ro_Acta_Finiquito_ro_cargo] FOREIGN KEY ([IdEmpresa], [IdCargo]) REFERENCES [dbo].[ro_cargo] ([IdEmpresa], [IdCargo]),
    CONSTRAINT [FK_ro_Acta_Finiquito_ro_contrato] FOREIGN KEY ([IdEmpresa], [IdEmpleado], [IdContrato]) REFERENCES [dbo].[ro_contrato] ([IdEmpresa], [IdEmpleado], [IdContrato]),
