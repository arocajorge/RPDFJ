CREATE TABLE [dbo].[fa_pedido_x_formaPago] (
    ...
    CONSTRAINT [FK_fa_pedido_x_formaPago_fa_TerminoPago] FOREIGN KEY ([IdTipoFormaPago]) REFERENCES [dbo].[fa_TerminoPago] ([IdTerminoPago])
);
