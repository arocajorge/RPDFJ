...
CREATE PROCEDURE  [dbo].[spROL_Valor_Pendiente_pago_x_Empleado_Acta_Finiquito]
@IdEmpresa int,
@IdNomina int,
@idempleado decimal,
@FechaIngreso date,
...
set @IdNomina =1
set @idempleado =327
set @FechaIngreso='10/06/2017'
set @FechaSalida='15/08/2017'
*/
BEGIN
...
and dbo.ro_rol_detalle.IdEmpleado=@idempleado
and dbo.ro_periodo.pe_FechaIni between @FechaIngreso  and @FechaSalida
