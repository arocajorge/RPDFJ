...
from 
(
			select A.IdEmpresa, A.IdEmpleado, A.pe_apellido,A.pe_nombre,A.pe_cedulaRuc,A.CodigoSectorial,A.ca_descripcion, sum(A.valor) as Valor, A.pe_sexo,A.Estado,A.Centro_costo,A.em_fechaIngaRol
			from 
			(
SELECT        dbo.ro_empleado.IdEmpresa, dbo.ro_empleado.IdEmpleado, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.tb_persona.pe_cedulaRuc, dbo.ro_empleado.CodigoSectorial, dbo.ro_cargo.ca_descripcion, 
                         dbo.ro_empleado.em_status, dbo.ro_periodo.pe_FechaIni, dbo.ro_periodo.pe_FechaFin, dbo.ro_rol_detalle.Valor, dbo.tb_persona.pe_sexo, dbo.ro_catalogo.ca_descripcion AS Estado, 
                         dbo.ct_centro_costo_sub_centro_costo.Centro_costo, dbo.ro_empleado.em_fechaSalida, dbo.ro_empleado.em_fechaIngaRol
FROM            dbo.Af_Activo_fijo INNER JOIN
                         ...
                         dbo.ro_catalogo ON dbo.ro_empleado.em_status = dbo.ro_catalogo.CodCatalogo ON Fj_servindustrias.ro_empleado_x_Activo_Fijo.IdEmpresa = dbo.ro_empleado.IdEmpresa AND 
			...
			group by A.IdEmpresa,A.IdEmpleado, A.pe_apellido,A.pe_nombre,A.pe_cedulaRuc,A.CodigoSectorial,A.ca_descripcion,A.pe_sexo,A.Estado,A.Centro_costo,A.em_fechaIngaRol
