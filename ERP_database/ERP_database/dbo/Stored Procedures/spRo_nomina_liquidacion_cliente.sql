...
and grup.IdRubro_Alim=@Dias_trabajados
...
,rub_visible_reporte,	Observacion)
select
@IdEmpresa	,@IdNomina,@IdNominaTipo,@IdPEriodo									,rol_det.IdEmpleado		,@IdRubro_calculado	,ISNULL( @Orden,0)			, ROUND((g.Sueldo/30)*rol_det.Valor ,2)
,1						,'SUELDO BASE'	
