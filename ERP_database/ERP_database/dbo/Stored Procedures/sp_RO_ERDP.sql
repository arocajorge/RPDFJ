...
declare 
 ...
 SELECT        dbo.ro_cargo.ca_descripcion AS cargo, dbo.ro_Departamento.de_descripcion AS departamento, dbo.ro_empleado.IdEmpresa, dbo.ro_empleado.IdEmpleado, 
                         ...
                         dbo.tb_persona.pe_nombre AS Nombre, dbo.tb_persona.IdTipoPersona, dbo.tb_persona.IdTipoDocumento, dbo.tb_persona.pe_cedulaRuc, 
                         dbo.tb_persona.pe_direccion, dbo.tb_persona.pe_telefonoCasa, dbo.tb_persona.pe_telefonoOfic, dbo.tb_persona.pe_telefonoInter, 
                         dbo.tb_persona.pe_celular,  dbo.tb_persona.pe_fax, dbo.tb_persona.pe_sexo, dbo.tb_persona.IdEstadoCivil, dbo.tb_persona.pe_fechaNacimiento, dbo.tb_persona.pe_estado, dbo.tb_persona.pe_fechaCreacion, 
