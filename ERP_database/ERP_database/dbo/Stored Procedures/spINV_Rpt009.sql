...
--exec [dbo].[spINV_Rpt009] 1,2,2,1,1,0,99999,'01/09/2020'
...
SELECT        in_movi_inve_detalle.IdEmpresa, in_movi_inve_detalle.IdSucursal, in_movi_inve_detalle.IdBodega, tb_bodega.bo_Descripcion AS nom_bodega, 
                         ...
                         ISNULL(ROUND(SUM(in_movi_inve_detalle.dm_cantidad),2),0) AS Stock, in_movi_inve_detalle.IdProducto, ISNULL(SUM(in_movi_inve_detalle.dm_cantidad * in_movi_inve_detalle.mv_costo) / IIF(SUM(in_movi_inve_detalle.dm_cantidad) = 0, 1, SUM(in_movi_inve_detalle.dm_cantidad)) ,0) AS mv_costo, 
...
FROM            in_categorias INNER JOIN
						 ...
						 inner join in_ProductoTipo as t on in_Producto.IdEmpresa = t.IdEmpresa and in_Producto.IdProductoTipo = t.IdProductoTipo
