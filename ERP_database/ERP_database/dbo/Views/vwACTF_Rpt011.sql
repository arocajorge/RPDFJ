...
SELECT        dbo.Af_Depreciacion.IdEmpresa, dbo.Af_Depreciacion.IdDepreciacion, dbo.Af_Depreciacion.IdPeriodo, dbo.Af_Activo_fijo.Af_Nombre AS nom_activo, 
                         ...
                         dbo.Af_Depreciacion_Det.Es_Activo_x_Mejora) AS Valor_dep_Ant, dbo.Af_Depreciacion.Estado, dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo, 
...
FROM            dbo.Af_Activo_fijo INNER JOIN
                         ...
                         dbo.Af_Activo_fijo.IdActijoFijoTipo = dbo.Af_Activo_fijo_Categoria.IdActivoFijoTipo INNER JOIN
