...
AS
SELECT        OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.oc_fecha, OC.oc_observacion, OC.IdEstadoAprobacion_cat, OC.Estado, Prov.IdProveedor, Prov.pr_nombre AS nom_proveedor, Prod.IdProducto, 
