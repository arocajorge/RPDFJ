...
SELECT dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, dbo.fa_factura.IdSucursal, dbo.fa_factura.CodCbteVta, dbo.fa_factura.vt_tipoDoc, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, 
                  ...
                  dbo.fa_factura.vt_seguro, ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.SubTotal_0,0) + ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.SubTotal_Iva,0) AS vt_Subtotal, ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.vt_iva,0)vt_iva, 
                  ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.SubTotal_0,0)SubTotal_0, ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.SubTotal_Iva,0)SubTotal_Iva, ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.vt_total,0)vt_total, dbo.fa_factura.IdPuntoVta, ct.cbte, ISNULL(cobro.valor_cobro, 0) 
                  AS valor_cobro, ROUND(ROUND(ISNULL(dbo.vwfa_factura_subtotal_iva_0_totales.vt_total,0), 2) - ROUND(ISNULL(cobro.valor_cobro, 0), 2), 2) AS vt_saldo, formas_pago.IdFormaPago, dbo.fa_formaPago.nom_FormaPago, 
                  formas_pago.cant_forma_pago
