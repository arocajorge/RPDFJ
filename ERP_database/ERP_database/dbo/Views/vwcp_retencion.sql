...
SELECT re.IdEmpresa, re.IdRetencion, re.IdEmpresa_Ogiro, Og.IdCbteCble_Ogiro AS IdCbte_CXP, Og.IdTipoCbte_Ogiro, SUBSTRING(TiDoc.Descripcion, 1, 3) + '-' + + Og.co_serie + '-' + Og.co_factura AS Factura_Prov, Og.co_FechaFactura, 
                  ...
                  re.re_EstaImpresa AS ImpresaRT, re.observacion AS observacionRT, re.re_Tiene_RTiva, re.re_Tiene_RFuente, Prov.IdProveedor, Prov.pr_nombre AS Nombre_Prov, TiDoc.Descripcion, SUM(dbo.cp_retencion_det.re_valor_retencion) 
...
GROUP BY re.IdEmpresa_Ogiro, Og.IdCbteCble_Ogiro, Og.IdTipoCbte_Ogiro, SUBSTRING(TiDoc.Descripcion, 1, 3) + '-' + + Og.co_serie + '-' + Og.co_factura, Og.co_FechaFactura, re.IdRetencion, 
                  ...
                  re.NAutorizacion, re.Estado, re.re_EstaImpresa, re.observacion, re.re_Tiene_RTiva, re.re_Tiene_RFuente, Prov.IdProveedor, Prov.pr_nombre, TiDoc.Descripcion, re.IdEmpresa, re.serie1 + '-' + re.serie2, re.NumRetencion, re.IdUsuario, 
