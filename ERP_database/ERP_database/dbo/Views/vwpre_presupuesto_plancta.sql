CREATE VIEW [dbo].[vwpre_presupuesto_plancta]
AS
SELECT     dbo.pre_presupuesto.IdPresupuesto, dbo.pre_presupuesto.IdAnio, dbo.ct_plancta.IdCtaCble, dbo.pre_presupuesto.Secuencia, 
                      ...
                      dbo.pre_presupuesto.Octubre, dbo.pre_presupuesto.Noviembre, dbo.pre_presupuesto.Diciembre, dbo.pre_presupuesto.Total, dbo.ct_plancta.IdEmpresa
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwpre_presupuesto_plancta';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[30] 4[18] 2[23] 3) )"
      End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwpre_presupuesto_plancta';
