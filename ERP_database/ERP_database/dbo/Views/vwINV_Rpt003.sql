...
SELECT        ing_egr.IdEmpresa, ing_egr.IdSucursal, ing_egr.IdNumMovi, ing_egr.signo, ing_egr.IdMovi_inven_tipo, ing_egr.CodMoviInven, ing_egr.cm_observacion, ing_egr.cm_fecha, ing_egr.Estado, 
                         ing_egr_det.IdEmpresa_inv, ing_egr_det.IdSucursal_inv, ing_egr_det.IdBodega_inv, ing_egr_det.IdMovi_inven_tipo_inv, ing_egr_det.IdNumMovi_inv, ing_egr.IdMotivo_oc, com_mot.Descripcion, 
                         ...
                         ing_egr_det.dm_precio, ing_egr_det.mv_costo, ing_egr_det.IdEstadoAproba, ing_egr_det.IdUnidadMedida, dbo.ct_centro_costo.IdCentroCosto, dbo.ct_centro_costo.Centro_costo, 
                         ...
                         dbo.in_Motivo_Inven.Desc_mov_inv AS Nom_Motivo_Inv, dbo.in_Producto.pr_descripcion AS Nom_producto, ing_egr_det.dm_stock_ante, ing_egr_det.dm_stock_actu, ing_egr_det.dm_cantidad_sinConversion, 
...
FROM            dbo.in_Motivo_Inven INNER JOIN
                         ...
                         dbo.com_Motivo_Orden_Compra AS com_mot ON ing_egr.IdEmpresa = com_mot.IdEmpresa AND ing_egr.IdMotivo_oc = com_mot.IdMotivo
GO
