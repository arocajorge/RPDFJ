...
SELECT        cabfac.IdEmpresa, cabfac.IdSucursal, cabfac.IdBodega, cabfac.vt_tipoDoc, 
                         ...
                         cabfac.IdCbteVta AS IdComprobante, cabfac.CodCbteVta AS CodComprobante, Sucu.Su_Descripcion, cabfac.IdCliente, cabfac.vt_fecha, ROUND(SUM(detfac.vt_total) 
                         + AVG(cabfac.vt_flete) + AVG(cabfac.vt_interes) + AVG(cabfac.vt_OtroValor1) + AVG(cabfac.vt_OtroValor2), 2) AS vt_total, ROUND(SUM(detfac.vt_total) 
                         + AVG(cabfac.vt_flete) + AVG(cabfac.vt_interes) + AVG(cabfac.vt_OtroValor1) + AVG(cabfac.vt_OtroValor2), 2) 
