...
AS
SELECT        c.IdEmpresa, c.IdCaja, c.ca_Codigo, c.ca_Descripcion, c.ca_Moneda, c.IdCtaCble, c.IdUsuario, c.Fecha_Transac, c.IdUsuarioUltMod, c.Fecha_UltMod, c.nom_pc, c.ip, 
                         c.Estado, c.IdUsuario_Responsable, c.IdUsuarioUltAnu, c.Fecha_UltAnu, c.MotivoAnu, u.Nombre, c.IdSucursal, S.Su_Descripcion, c.IdMoneda, 
                         dbo.tb_moneda.im_descripcion, c.IdPunto_cargo, c.IdPunto_cargo_grupo
FROM            dbo.caj_Caja AS c INNER JOIN
                         ...
                         dbo.tb_moneda ON c.IdMoneda = dbo.tb_moneda.IdMoneda LEFT OUTER JOIN
