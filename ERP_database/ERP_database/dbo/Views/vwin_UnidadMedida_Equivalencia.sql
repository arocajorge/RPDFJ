CREATE VIEW [dbo].[vwin_UnidadMedida_Equivalencia]
AS
SELECT        dbo.in_UnidadMedida_Equiv_conversion.IdUnidadMedida, dbo.in_UnidadMedida_Equiv_conversion.IdUnidadMedida_equiva, dbo.in_UnidadMedida.cod_alterno, 
                         dbo.in_UnidadMedida.Descripcion, dbo.in_UnidadMedida_Equiv_conversion.valor_equiv, dbo.in_UnidadMedida_Equiv_conversion.interpretacion, 
                         uniPadre.cod_alterno AS cod_alterno_Padre, uniPadre.Descripcion AS Descripcion_Padre
FROM            dbo.in_UnidadMedida_Equiv_conversion INNER JOIN
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "in_UnidadMedida_Equiv_conversion"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 135
