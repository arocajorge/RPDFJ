CREATE VIEW [dbo].[vwro_Empleado_TNomina]
AS
SELECT     dbo.ro_Nomina_Tipo.IdEmpresa, dbo.ro_Nomina_Tipo.IdNomina_Tipo, dbo.ro_Nomina_Tipo.Descripcion AS Descripcion_Nomina, 
                      dbo.ro_Empleado_x_ro_tipoNomina.IdEmpleado
FROM         dbo.ro_Nomina_Tipo INNER JOIN
                      dbo.ro_empleado ON dbo.ro_Nomina_Tipo.IdEmpresa = dbo.ro_empleado.IdEmpresa LEFT OUTER JOIN
