...
FROM            (SELECT        dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, 
                                                    ...
                                                    dbo.cp_proveedor.IdPersona, dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_orden_giro.co_valorpagar AS Valor_a_pagar, 0 AS Valor_debe, 
                          ...
                          SELECT        A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, OG.IdOrden_giro_Tipo, 'Ret#' + CAST(A.IdRetencion AS varchar(20)) 
                                                   ...
                                                   OG.IdProveedor, Prov.IdPersona, Prov.pr_nombre, SUM(B.re_valor_retencion) AS re_valor_retencion, SUM(B.re_valor_retencion) AS Valor_debe, 
                          ...
                          GROUP BY A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, OG.IdOrden_giro_Tipo, TipDoc.Codigo, OG.co_factura, A.NumRetencion, TipDoc.Descripcion, 
                                                   A.fecha, OG.IdProveedor, Prov.IdPersona, Prov.pr_nombre, A.observacion, Prov.IdClaseProveedor, prov_cla.descripcion_clas_prove, Suc.IdSucursal, 
                          ...
                          SELECT        dbo.cp_nota_DebCre.IdEmpresa, dbo.cp_nota_DebCre.IdCbteCble_Nota, dbo.cp_nota_DebCre.IdTipoCbte_Nota, '05', 
                                                   ...
                                                   'PROVEE' AS Tipo_persona, dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.IdPersona, dbo.cp_proveedor.pr_nombre AS nom_proveedor, 
