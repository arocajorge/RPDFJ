CREATE VIEW dbo.vwAca_Familiar_x_Estudiante_RepEco
AS
SELECT        dbo.Aca_Familiar_x_Estudiante.IdEstudiante, dbo.Aca_Familiar_x_Estudiante.IdFamiliar, dbo.tb_persona.pe_apellido AS Apellido, dbo.tb_persona.pe_nombre AS Nombre, 
                         ...
                         dbo.Aca_Familiar.empresa_donde_trabaja, dbo.Aca_Familiar.empresa_direccion, dbo.Aca_Familiar.IdNivelEducativo_cat, dbo.Aca_Familiar_x_Estudiante.activo, dbo.Aca_Familiar_x_Estudiante.IdInstitucion, 
                         dbo.tb_persona.pe_correo
...
WHERE        (dbo.Aca_Familiar_x_Estudiante.IdParentesco_cat = 'REP_ECO') OR
                         (dbo.Aca_Familiar_x_Estudiante.IdParentesco_cat = 'REP_ECO_DUAL')
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwAca_Familiar_x_Estudiante_RepEco';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwAca_Familiar_x_Estudiante_RepEco';
