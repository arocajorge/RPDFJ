...
/*-NOTAS DE CREDITOS*/ SELECT A.IdEmpresa, A.IdCbteCble_Nota, A.IdTipoCbte_Nota, A.cn_fecha, A.cn_observacion, A.cn_observacion AS referencia, D .tc_TipoCbte, a.cn_total AS Valor_Cbte, 
                         ...
                         A.IdCbteCble_Nota AS Expr2, NULL AS Expr3, P.IdCtaCble_CXP AS IdCtaCble, P.IdCtaCble_Anticipo AS IdCtaAnticipo, P.pr_nombre AS Beneficiario, P.IdProveedor AS IdEntidad
...
GROUP BY A.IdEmpresa, A.IdCbteCble_Nota, A.IdTipoCbte_Nota, A.cn_fecha, a.cn_total, A.cn_observacion, D .tc_TipoCbte, P.IdCtaCble_CXP, P.IdCtaCble_Anticipo, P.pr_nombre, P.IdProveedor