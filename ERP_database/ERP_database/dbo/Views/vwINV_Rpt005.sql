...
AS
SELECT        c.IdEmpresa, c.IdProducto, c.pr_codigo, c.pr_descripcion, b.IdBodega, b.IdSucursal, a.dm_stock_ante, a.dm_cantidad, a.dm_stock_actu, a.mv_costo, b.IdNumMovi, 
