...
AS
SELECT        af.IdEmpresa, af.Id_Mejora_Baja_Activo, af.Id_Tipo, act.IdActivoFijo, act.Af_Nombre, emp.nom_encargado AS NomCompleto, mar.Descripcion AS Af_Marca, dis.Descripcion AS Af_Modelo, act.Af_NumSerie, 
                         col.Descripcion AS Af_Color, ubi.Descripcion AS Af_Ubicacion, act.Af_Vida_Util, act.Af_Meses_depreciar, act.Af_porcentaje_deprec, pro.IdProveedor, pro.pr_nombre, af.ValorActivo, af.Valor_Mej_Baj_Activo, af.Compr_Mej_Baj, 
