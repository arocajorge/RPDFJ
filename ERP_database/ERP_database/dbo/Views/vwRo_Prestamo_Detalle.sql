...
AS
SELECT        dbo.ro_prestamo.IdEmpresa, dbo.ro_prestamo.IdNomina_Tipo, dbo.ro_prestamo.IdEmpleado, dbo.ro_prestamo.IdPrestamo, dbo.ro_prestamo.IdRubro, 
                         dbo.ro_rubro_tipo.ru_codRolGen, dbo.ro_rubro_tipo.ru_descripcion, dbo.ro_prestamo.Estado AS EstadoPrestamo, dbo.ro_prestamo_detalle.Saldo, 
                         dbo.ro_prestamo_detalle.FechaPago, dbo.ro_prestamo_detalle.EstadoPago, dbo.ro_prestamo_detalle.Estado AS EstadoDetalle, dbo.ro_prestamo_detalle.TotalCuota,
                          dbo.ro_prestamo_detalle.NumCuota, dbo.ro_prestamo_detalle.SaldoInicial, dbo.ro_prestamo_detalle.Interes, dbo.ro_prestamo_detalle.AbonoCapital, 
