...
UNION
SELECT Af_Activo_fijo.IdEmpresa, Af_Activo_fijo.IdActivoFijo, Af_Activo_fijo_CtasCbles_Tipo.IdTipoCuenta, ROW_NUMBER() OVER (ORDER BY Af_Activo_fijo.IdEmpresa DESC) Secuencia, 100, NULL, NULL, '', Af_Activo_fijo.IdActijoFijoTipo,
NULL
...
SELECT dbo.Af_Activo_fijo.IdEmpresa, dbo.Af_Activo_fijo.IdActivoFijo, dbo.Af_Activo_fijo_CtasCbles_Tipo.IdTipoCuenta, 
                  ...
                  CASE WHEN dbo.Af_Activo_fijo_CtasCbles_Tipo.IdTipoCuenta = 'CTA_ACTIVO' THEN dbo.Af_Activo_fijo_tipo.IdCtaCble_Activo WHEN dbo.Af_Activo_fijo_CtasCbles_Tipo.IdTipoCuenta = 'CTA_DEPRE_ACUM' THEN dbo.Af_Activo_fijo_tipo.IdCtaCble_Dep_Acum
                   ELSE dbo.Af_Activo_fijo_tipo.IdCtaCble_Gastos_Depre END AS IdCtaCble, dbo.Af_Activo_fijo.IdCentroCosto, '' AS Observacion, Af_Activo_fijo.IdActijoFijoTipo,
				   NULL
FROM     dbo.Af_Activo_fijo_tipo INNER JOIN
                  dbo.Af_Activo_fijo ON dbo.Af_Activo_fijo_tipo.IdEmpresa = dbo.Af_Activo_fijo.IdEmpresa AND dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo = dbo.Af_Activo_fijo.IdActijoFijoTipo INNER JOIN
