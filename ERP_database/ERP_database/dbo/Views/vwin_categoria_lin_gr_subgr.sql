...
from (
		...
		SELECT        IdEmpresa, IdCategoria AS ID, IdCategoriaPadre AS IDPadre, NULL AS Codigo, '['+IdCategoria+'] '+ca_Categoria AS descripcion, Estado, IdCategoria, NULL AS IdLinea, NULL 
