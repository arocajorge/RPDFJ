CREATE VIEW [dbo].[vwcxc_cobro_tipo_Param_conta_x_sucursal]
AS
SELECT        dbo.cxc_cobro_tipo_Param_conta_x_sucursal.IdEmpresa, dbo.cxc_cobro_tipo_Param_conta_x_sucursal.IdSucursal, 
                         dbo.cxc_cobro_tipo_Param_conta_x_sucursal.IdCobro_tipo, dbo.cxc_cobro_tipo_Param_conta_x_sucursal.IdCtaCble, RTRIM(dbo.tb_sucursal.Su_Descripcion) 
                         AS Sucursal, dbo.cxc_cobro_tipo_Param_conta_x_sucursal.IdCtaCble_Anticipo
FROM            dbo.cxc_cobro_tipo_Param_conta_x_sucursal INNER JOIN
