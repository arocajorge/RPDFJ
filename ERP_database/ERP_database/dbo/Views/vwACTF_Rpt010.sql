...
AS
SELECT        cam.IdEmpresa, cam.IdCambioUbicacion, act.IdActivoFijo, act.Af_Nombre, tip.IdActijoFijoTipo, tip.Af_Descripcion, cam.IdSucursal_Actu, suc_act.Su_Descripcion AS SucActual, cam.IdSucursal_Ant, 
...
FROM            dbo.Af_Catalogo AS ubi_act INNER JOIN
                         ...
                         dbo.Af_Activo_fijo AS act ON tip.IdEmpresa = act.IdEmpresa AND tip.IdActijoFijoTipo = act.IdActijoFijoTipo ON cam.IdEmpresa = act.IdEmpresa AND cam.IdActivoFijo = act.IdActivoFijo LEFT OUTER JOIN
