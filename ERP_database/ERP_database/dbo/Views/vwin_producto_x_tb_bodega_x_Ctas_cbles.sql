...
SELECT        dbo.tb_sucursal.IdEmpresa, dbo.tb_sucursal.IdSucursal, dbo.tb_sucursal.Su_Descripcion AS nom_sucursal, dbo.tb_bodega.IdBodega, dbo.tb_bodega.bo_Descripcion AS nom_bodega, 
                         ...
                         dbo.in_producto_x_tb_bodega.IdCtaCble_Costo, dbo.in_producto_x_tb_bodega.IdCtaCble_Vta, dbo.in_producto_x_tb_bodega.IdCtaCble_Gasto_x_cxp, dbo.in_producto_x_tb_bodega.IdCtaCble_Des0, 
                         dbo.in_producto_x_tb_bodega.IdCtaCble_Dev0, dbo.in_categorias.IdCategoria, dbo.in_categorias.ca_Categoria AS nom_categoria, dbo.in_linea.IdLinea, dbo.in_linea.nom_linea, dbo.in_grupo.IdGrupo, 
