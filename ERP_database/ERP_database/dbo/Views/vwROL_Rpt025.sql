...
SELECT        dbo.tb_persona.pe_cedulaRuc AS CedulaRuc, dbo.tb_persona.pe_nombreCompleto AS NombreCompleto, dbo.ro_empleado_novedad_det.IdRubro, dbo.ro_empleado_novedad_det.FechaPago, 
                         ...
                         dbo.ro_Departamento.de_descripcion AS Departamento, dbo.ro_empleado_Novedad.IdEmpresa, dbo.ro_empleado_Novedad.IdEmpleado, dbo.ro_empleado.IdDivision, 
                         dbo.ro_empleado.em_codigo AS CodigoEmpleado, dbo.ro_Departamento.IdDepartamento, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.ro_empleado_novedad_det.Num_Horas, 
