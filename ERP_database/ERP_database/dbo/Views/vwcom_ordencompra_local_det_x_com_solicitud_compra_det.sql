...
SELECT        OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.IdProveedor, OC.oc_NumDocumento, OC.Tipo, OC.IdTerminoPago, OC.oc_plazo, OC.oc_fecha, OC.oc_flete, 
                         ...
                         Apr.descripcion AS ap_descripcion, PAgo.descripcion AS tp_descripcion, REc.descripcion AS rec_descripcion, Prov.pr_nombre, dbo.tb_sucursal.Su_Descripcion, 
...
GROUP BY OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.IdProveedor, OC.oc_NumDocumento, OC.Tipo, OC.IdTerminoPago, OC.oc_plazo, OC.oc_fecha, OC.oc_flete, 
                         ...
                         Apr.descripcion, PAgo.descripcion, REc.descripcion, Prov.pr_nombre, dbo.tb_sucursal.Su_Descripcion, OC.IdDepartamento, OC.Solicitante, OC.IdSolicitante, 
