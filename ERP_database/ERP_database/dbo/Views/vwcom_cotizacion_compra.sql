CREATE VIEW dbo.vwcom_cotizacion_compra
AS
SELECT     dbo.com_cotizacion_compra.IdEmpresa, dbo.com_cotizacion_compra.IdCotizacion, dbo.com_cotizacion_compra.IdSucursal, 
                      dbo.com_cotizacion_compra.Observacion, dbo.tb_sucursal.Su_Descripcion AS nom_sucursal, dbo.com_cotizacion_compra.Fecha, 
                      dbo.com_cotizacion_compra.Estado, dbo.com_cotizacion_compra.Fecha_Transac, dbo.com_cotizacion_compra.Fecha_UltMod, 
                      dbo.com_cotizacion_compra.IdUsuarioUltMod, dbo.com_cotizacion_compra.FechaHoraAnul, dbo.com_cotizacion_compra.IdUsuarioUltAnu, 
                      dbo.com_cotizacion_compra.MotivoAnulacion, dbo.com_cotizacion_compra.IdProveedor
