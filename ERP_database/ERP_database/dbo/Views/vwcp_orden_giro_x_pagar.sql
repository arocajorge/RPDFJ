CREATE view  vwcp_orden_giro_x_pagar
as
SELECT        OG.IdEmpresa, OG.IdCbteCble_Ogiro, OG.IdTipoCbte_Ogiro, OG.IdOrden_giro_Tipo, OG.IdProveedor, OG.co_serie, OG.co_factura + '/' + CAST(OG.IdCbteCble_Ogiro AS varchar(20)) AS co_factura, OG.co_FechaFactura, 
                         ...
                         co_valorpagar, ROUND(ISNULL(OP.Total_Cancelado_OP, 0), 2) AS Total_Pagado, round(OG.co_total - isnull(ret.re_valor_retencion, 0) - ISNULL(OP.Total_Cancelado_OP, 0), 2) AS Saldo_OG, 
