...
SELECT OG.IdEmpresa, OG.IdCbteCble_Ogiro, OG.IdTipoCbte_Ogiro, OG.IdOrden_giro_Tipo, OG.IdProveedor, OG.co_serie, OG.co_factura + '/' + CAST(OG.IdCbteCble_Ogiro AS varchar(20)) AS co_factura, OG.co_FechaFactura, 
                  ...
                  AS Total_Pagado, ROUND(ROUND(OG.co_valorpagar, 2) - ROUND(ISNULL(OP.Total_Cancelado_OP, 0), 2), 2) AS Saldo_OG, dbo.cp_TipoDocumento.Descripcion AS nom_tipo_Documento, dbo.cp_proveedor.pr_nombre AS nom_proveedor, 
...
SELECT dbo.cp_nota_DebCre.IdEmpresa, dbo.cp_nota_DebCre.IdCbteCble_Nota, dbo.cp_nota_DebCre.IdTipoCbte_Nota, '05' AS Expr4, dbo.cp_nota_DebCre.IdProveedor, CASE WHEN cp_nota_DebCre.cn_serie1 IS NULL 
                  ...
                  ROUND(ROUND(dbo.cp_nota_DebCre.cn_total, 2) - ROUND(ISNULL(OP.Total_Cancelado_OP, 0), 2), 2) AS Saldo, 'Nota de débito' AS Expr5, dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.ct_cbtecble_tipo.CodTipoCbte, 
