...
SELECT        dbo.vwRo_Rol_Detalle.IdEmpleado, dbo.vwRo_Rol_Detalle.Ruc, dbo.vwRo_Rol_Detalle.Empleado, dbo.vwRo_Rol_Detalle.IdRubro, dbo.vwRo_Rol_Detalle.Tag, 
                         ...
                         dbo.ro_rubro_tipo.ru_estado, dbo.ro_rubro_tipo.ru_orden, dbo.ro_rubro_tipo.ru_EditablexUser, dbo.ro_rubro_tipo.IdUsuario, dbo.ro_rubro_tipo.rub_concep, 
                         dbo.ro_rubro_tipo.rub_tipcal, dbo.ro_rubro_tipo.rub_formul, dbo.ro_rubro_tipo.rub_valfij, dbo.ro_rubro_tipo.rub_legal, dbo.ro_rubro_tipo.rub_foract, 
                         dbo.ro_rubro_tipo.rub_fornom, dbo.ro_rubro_tipo.rub_gencon, dbo.ro_rubro_tipo.rub_antici, dbo.ro_rubro_tipo.rub_ctacon, dbo.ro_rubro_tipo.rub_liquida, 
                         dbo.ro_rubro_tipo.rub_provision, dbo.ro_rubro_tipo.rub_noafecta, dbo.ro_rubro_tipo.rub_acumula, dbo.ro_rubro_tipo.rub_prorrateo, dbo.ro_rubro_tipo.rub_nocontab, 
                         dbo.ro_rubro_tipo.rub_utilid, dbo.ro_rubro_tipo.rub_guarda_rol, dbo.ro_rubro_tipo.rub_aplica_IESS, dbo.ro_rubro_tipo.rub_grupo
