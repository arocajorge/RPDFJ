...
SELECT        dbo.cp_orden_giro.IdEmpresa, NULL AS IdOrdenPago, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, 
                         ...
                         dbo.cp_proveedor.IdPersona, dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre AS Nom_Proveedor, dbo.cp_orden_giro.co_baseImponible AS SubTotal, 
...
SELECT        dbo.cp_nota_DebCre.IdEmpresa, NULL AS IdOrdenPago, dbo.cp_nota_DebCre.IdCbteCble_Nota, dbo.cp_nota_DebCre.IdTipoCbte_Nota, '05', 'ND' AS cod_tipo_doc, 
                         ...
                         ltrim(rtrim(dbo.cp_proveedor.pr_nombre)) AS Nom_Proveedor, dbo.cp_nota_DebCre.cn_baseImponible AS SubTotal, dbo.cp_nota_DebCre.cn_valoriva AS Iva, 
