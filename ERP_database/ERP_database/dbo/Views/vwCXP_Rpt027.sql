...
SELECT        dbo.cp_conciliacion_Caja_det_x_ValeCaja.IdEmpresa, dbo.cp_conciliacion_Caja_det_x_ValeCaja.IdConciliacion_Caja, 
                         ...
                         dbo.cp_conciliacion_Caja_det_x_ValeCaja.IdCtaCble, dbo.caj_Caja_Movimiento.cm_valor, dbo.caj_Caja_Movimiento.cm_beneficiario, 
...
FROM            dbo.cp_conciliacion_Caja_det_x_ValeCaja INNER JOIN
                         ...
                         dbo.cp_conciliacion_Caja_det_x_ValeCaja.IdCtaCble = dbo.ct_plancta.IdCtaCble
GO
