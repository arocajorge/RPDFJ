...
as
SELECT        M.IdMenu, M.IdMenuPadre, M.DescripcionMenu, M.PosicionMenu, M.Habilitado, M.Tiene_FormularioAsociado, M.nom_Formulario, M.nom_Asembly, 
                         M.imagen_grande, M.imagen_peque, M.icono, M.nivel, M_x_E_x_U.IdEmpresa, M_x_E_x_U.IdUsuario, 
