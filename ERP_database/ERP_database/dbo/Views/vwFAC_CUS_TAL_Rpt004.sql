...
SELECT     fa.IdEmpresa, fa.IdSucursal, fa.IdBodega, fa.IdCbteVta, fa.CodCbteVta, fa.vt_tipoDoc, fa.vt_autorizacion, fa.vt_serie1, fa.vt_serie2, fa.vt_NumFactura, fa.IdCliente, 
                      fa.IdVendedor, fa.vt_fecha, fa.vt_plazo, fa.vt_fech_venc, fa.vt_tipo_venta, fa.vt_Observacion, fa.vt_flete, fa.vt_interes, fa.vt_seguro, fa.vt_OtroValor1, fa.vt_OtroValor2, 
                      ...
                      fa_det.vt_Subtotal, fa_det.vt_iva, fa_det.vt_total,0 vt_costo, fa_det.vt_Peso, fa_det.vt_detallexItems, caj.ca_Descripcion AS nom_caja, 
                      ...
                      perso.pe_telefonoOfic AS telef_cliente, perso.pe_correo AS correo_cliente
