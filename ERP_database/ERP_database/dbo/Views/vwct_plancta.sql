...
AS
SELECT        dbo.ct_plancta.IdEmpresa, dbo.ct_plancta.IdCtaCble, dbo.ct_plancta.pc_Cuenta, dbo.ct_plancta.IdCtaCblePadre, dbo.ct_plancta.IdCatalogo, 
                         ...
                         dbo.ct_plancta.pc_es_flujo_efectivo, dbo.ct_plancta.pc_clave_corta, ISNULL(ct_plancta_1.pc_Cuenta, '') AS CuentaPadre, dbo.ct_plancta.IdTipoCtaCble
