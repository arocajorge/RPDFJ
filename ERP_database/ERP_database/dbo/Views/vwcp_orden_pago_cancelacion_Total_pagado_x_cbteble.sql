CREATE VIEW dbo.vwcp_orden_pago_cancelacion_Total_pagado_x_cbteble
AS
SELECT        IdEmpresa_cxp AS IdEmpresa_cbtecble, IdTipoCbte_cxp AS IdTipoCbte_cbtecble, IdCbteCble_cxp AS IdCbteCble_cbtecble, SUM(MontoAplicado) 
                         AS Total_Pagado
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[28] 4[33] 2[24] 3) )"
      End
