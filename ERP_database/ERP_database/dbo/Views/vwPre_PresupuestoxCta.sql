CREATE VIEW [dbo].[vwPre_PresupuestoxCta]
AS
SELECT     dbo.ct_plancta.IdEmpresa, dbo.ct_plancta.IdCtaCble, dbo.pre_presupuesto.IdPresupuesto, dbo.pre_presupuesto.IdAnio, dbo.pre_presupuesto.Secuencia, 
                      ...
                      dbo.pre_presupuesto.Octubre, dbo.pre_presupuesto.Noviembre, dbo.pre_presupuesto.Diciembre, dbo.pre_presupuesto.Total
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwPre_PresupuestoxCta';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[34] 4[31] 2[16] 3) )"
      End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwPre_PresupuestoxCta';
