CREATE VIEW dbo.vwCONTA_Rpt003
AS
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCONTA_Rpt003';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCONTA_Rpt003';
