...
FROM            fa_factura INNER JOIN
                         ...
                         fa_cliente ON fa_factura.IdEmpresa = fa_cliente.IdEmpresa AND fa_factura.IdCliente = fa_cliente.IdCliente AND tb_sucursal.IdEmpresa = fa_cliente.IdEmpresa AND tb_sucursal.IdSucursal = fa_cliente.IdSucursal INNER JOIN
...
FROM            fa_notaCreDeb INNER JOIN
                         ...
                         tb_sucursal ON tb_bodega.IdEmpresa = tb_sucursal.IdEmpresa AND tb_bodega.IdSucursal = tb_sucursal.IdSucursal INNER JOIN
                         fa_cliente ON fa_notaCreDeb.IdEmpresa = fa_cliente.IdEmpresa AND fa_notaCreDeb.IdCliente = fa_cliente.IdCliente AND tb_sucursal.IdEmpresa = fa_cliente.IdEmpresa AND 
                         tb_sucursal.IdSucursal = fa_cliente.IdSucursal INNER JOIN
                         fa_cliente_tipo ON fa_cliente_tipo.IdEmpresa = fa_cliente.IdEmpresa AND fa_cliente_tipo.Idtipo_cliente = fa_cliente.Idtipo_cliente INNER JOIN
                         tb_persona ON fa_cliente.IdPersona = tb_persona.IdPersona INNER JOIN
