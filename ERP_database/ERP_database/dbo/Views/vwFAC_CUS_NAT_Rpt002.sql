...
SELECT fac_det.IdEmpresa, fac_det.IdSucursal, fac_det.IdBodega, fac_det.IdCbteVta, fac_det.Secuencia, 
                         ...
                         fac_det.vt_estado, fac_det.vt_detallexItems, fac_det.vt_Peso, dbo.in_Producto.pr_codigo, 
...
FROM fa_factura fac INNER JOIN 
	 ...
	 dbo.fa_motivo_venta ON dbo.fa_motivo_venta.IdEmpresa = dbo.in_Producto.IdEmpresa AND dbo.fa_motivo_venta.IdMotivo_Vta = dbo.in_Producto.IdMotivo_Vta