...
SELECT        act.IdEmpresa, act.IdActivoFijo, act.IdSucursal, act.IdActijoFijoTipo, act.IdTipoDepreciacion, act.Af_Codigo_Barra, dep.nom_tipo_depreciacion, tip.Af_Descripcion, cat.Descripcion, suc.Su_Descripcion, act.Af_Nombre, 
                         act.IdDepartamento, mar.Descripcion AS Af_Marca, dis.Descripcion AS Af_Modelo, act.Af_NumSerie, col.Descripcion AS Af_Color, ubi.Descripcion AS Af_Ubicacion, emp.nom_encargado AS NomCompleto, act.Af_observacion, 
                         ...
                         AS Af_ValorSalvamento, ISNULL(act.Af_ValorResidual, 0) AS Af_ValorResidual, act.Estado_Proceso, per.IdPeriodoDeprec, per.Descripcion AS Descri_Periodo, ISNULL(vaDepre.Valor_Depreciacion, 0) AS Valor_Depreciacion, 
