...
as
SELECT        og.IdEmpresa, og.IdCbteCble_Ogiro, og.IdTipoCbte_Ogiro, og.IdOrden_giro_Tipo, og.IdProveedor, pro.pr_nombre AS nombreProveedor, og.co_fechaOg, 
...
FROM            dbo.cp_orden_giro AS og INNER JOIN
                         ...
                         dbo.tb_sucursal AS su ON og.IdSucursal = su.IdSucursal AND og.IdEmpresa = su.IdEmpresa
WHERE        (NOT EXISTS
