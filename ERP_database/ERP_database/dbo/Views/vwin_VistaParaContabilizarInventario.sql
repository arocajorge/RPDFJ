...
SELECT        mov_inv_det.IdEmpresa, mov_inv_det.IdSucursal, mov_inv_det.IdBodega, mov_inv_det.IdMovi_inven_tipo, mov_inv_det.IdNumMovi, mov_inv_det.Secuencia, 
                         mov_inv_det.mv_tipo_movi, mov_inv_det.IdProducto, mov_inv_det.dm_cantidad, mov_inv_det.dm_stock_ante, mov_inv_det.dm_stock_actu, 
                         mov_inv_det.dm_observacion, mov_inv_det.mv_costo, mov_inv_det.dm_peso, prod_x_bod.IdCtaCble_Inven, prod_x_bod.IdCtaCble_Costo, mov_inv.cm_fecha, 
                         ...
                         mov_inv_det.IdPunto_cargo, mov_inv_det.IdPunto_cargo_grupo, mov_inv_det.IdMotivo_Inv, dbo.in_Motivo_Inven.IdCtaCble_Inven AS IdCtaCble_Inven_Motivo, 
                         dbo.in_Motivo_Inven.IdCtaCble_Costo AS IdCtaCble_Costo_Motivo
