CREATE VIEW [dbo].[vwtb_tb_sis_Documento_Tipo_Talonario]
AS
SELECT dbo.tb_sis_Documento_Tipo_Talonario.IdEmpresa, dbo.tb_empresa.em_ruc, dbo.tb_sis_Documento_Tipo_Talonario.CodDocumentoTipo, dbo.tb_sis_Documento_Tipo_Talonario.Establecimiento, 
                  dbo.tb_sis_Documento_Tipo_Talonario.PuntoEmision, dbo.tb_sis_Documento_Tipo_Talonario.NumDocumento, cast(dbo.tb_sis_Documento_Tipo_Talonario.NumDocumento as numeric) as NumDocumento_decimal
