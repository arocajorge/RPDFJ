...
FROM     dbo.cp_proveedor AS PRO INNER JOIN
                  ...
                  dbo.cp_codigo_SRI AS co ON c.IdCodigo_SRI = co.IdCodigo_SRI
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwcp_proveedor_codigo_SRI';
