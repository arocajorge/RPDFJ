...
FROM            (SELECT        A.IdEmpresa, A.IdTipo_op, SUBSTRING(D .Descripcion, 1, 3) + '#' + C.co_serie + ' -' + C.co_factura AS Referencia, SUBSTRING(D .Descripcion, 1, 3) 
                                                    ...
                                                    Pr.pr_nombre AS Nom_Beneficiario, Pr.pr_girar_cheque_a AS Girar_Cheque_a, C.co_valorpagar AS Valor_a_pagar, 
                                                    ...
                                                    + ']' + Pr.pr_nombre AS Nom_Beneficiario_2, C.IdEmpresa AS IdEmpresa_cxp, C.IdTipoCbte_Ogiro AS IdTipoCbte_cxp, 
                          ...
                          SELECT        A.IdEmpresa, A.IdTipo_op, 'ND' + '#:' + cast(cp_nota_DebCre.IdCbteCble_Nota AS varchar(20)) + cp_nota_DebCre.cn_observacion AS Referencia, 
                                                   ...
                                                   cp_nota_DebCre.cn_Fecha_vcto, A.Observacion, Pr.pr_nombre AS Nom_Beneficiario, Pr.pr_girar_cheque_a AS Girar_Cheque_a, 
                                                   ...
                                                   cp_nota_DebCre.IdCbteCble_Nota Cbte_cxp, cp_nota_DebCre.Estado, Pr.pr_nombre nom_beneficiario2, cp_nota_DebCre.IdEmpresa, 
                          ...
                          SELECT        C.IdEmpresa, 'FACT_PROVEE' AS IdTipo_op, SUBSTRING(D .Descripcion, 1, 3) + '#' + C.co_serie + ' -' + C.co_factura AS Referencia, 
                                                   ...
                                                   C.co_FechaFactura_vct AS Fecha_Venc_Fac_Prov, C.co_observacion, Pr.pr_nombre AS Nom_Beneficiario, Pr.pr_girar_cheque_a AS Girar_Cheque_a, 
