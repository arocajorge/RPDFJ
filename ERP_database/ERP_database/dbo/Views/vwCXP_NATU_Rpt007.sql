CREATE VIEW [dbo].[vwCXP_NATU_Rpt007]
AS
...
FROM            dbo.cp_orden_giro INNER JOIN
                         ...
                         dbo.cp_codigo_SRI_x_CtaCble ON dbo.cp_retencion_det.IdEmpresa = dbo.cp_codigo_SRI_x_CtaCble.IdEmpresa AND 
                         dbo.cp_retencion_det.IdCodigo_SRI = dbo.cp_codigo_SRI_x_CtaCble.idCodigo_SRI
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCXP_NATU_Rpt007';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'ight = 806
            End
            DisplayFlags = 280
            TopColumn = 0
         End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCXP_NATU_Rpt007';
      ...
      Begin Tables = 
         ...
         Begin Table = "cp_codigo_SRI_x_CtaCble"
            Begin Extent = 
               ...
               Left = 597
               Bottom = 273
               R', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCXP_NATU_Rpt007';
