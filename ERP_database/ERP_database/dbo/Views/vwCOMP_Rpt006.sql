...
SELECT        apro.IdEmpresa, suc.IdSucursal, apro.IdSolicitudCompra, apro.Secuencia_SC, apro.IdProducto_SC, suc.Su_Descripcion, apro.NomProducto_SC, solDet.do_Cantidad, apro.Cantidad_aprobada, 
                         ...
                         apro.do_ManejaIva, dbo.com_departamento.IdDepartamento, dbo.com_departamento.nom_departamento AS de_descripcion, dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre, 
...
FROM            dbo.com_solicitud_compra_det_aprobacion AS apro INNER JOIN
                         ...
                         dbo.in_UnidadMedida AS uniMed ON apro.IdUnidadMedida = uniMed.IdUnidadMedida
GO
