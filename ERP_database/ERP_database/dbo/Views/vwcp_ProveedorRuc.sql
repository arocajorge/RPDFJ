...
AS
SELECT        dbo.cp_proveedor.IdEmpresa, dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre, dbo.cp_proveedor.pr_codigo, dbo.cp_proveedor.pr_girar_cheque_a, 
                         dbo.cp_proveedor.IdTipoServicio, dbo.cp_proveedor.IdCtaCble_CXP, dbo.cp_proveedor.IdTipoGasto, dbo.cp_proveedor.pr_contribuyenteEspecial, 
                         dbo.cp_proveedor.pr_plazo, dbo.cp_proveedor.pr_estado, dbo.cp_proveedor.IdCiudad, dbo.cp_proveedor.pr_nacionalidad, dbo.cp_proveedor.idCredito_Predeter, 
                         ...
                         dbo.cp_proveedor.nom_pc, dbo.cp_proveedor.contacto, dbo.cp_proveedor.ip, dbo.cp_proveedor.responsable, dbo.cp_proveedor.comentario, 
                         ...
                         dbo.tb_persona.IdTipoPersona, dbo.tb_persona.IdTipoDocumento, dbo.tb_persona.pe_cedulaRuc, dbo.tb_persona.pe_direccion, dbo.tb_persona.pe_telefonoCasa, 
                         dbo.tb_persona.pe_telefonoOfic, dbo.tb_persona.pe_telefonoInter, dbo.tb_persona.pe_telfono_Contacto, dbo.tb_persona.pe_celular, dbo.tb_persona.pe_correo, 
                         dbo.tb_persona.pe_fax, dbo.tb_persona.pe_casilla, dbo.tb_persona.pe_sexo, dbo.tb_persona.IdEstadoCivil, dbo.tb_persona.pe_fechaNacimiento, 
                         dbo.tb_persona.pe_estado, dbo.tb_persona.pe_celularSecundario, dbo.tb_persona.pe_correo_secundario1, dbo.tb_persona.pe_correo_secundario2, 
...
FROM            dbo.cp_proveedor INNER JOIN
                         ...
                         dbo.vwtb_Ciudad ON dbo.cp_proveedor.IdCiudad = dbo.vwtb_Ciudad.IdCiudad
GO
