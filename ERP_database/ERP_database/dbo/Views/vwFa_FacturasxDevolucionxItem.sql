CREATE VIEW [dbo].[vwFa_FacturasxDevolucionxItem]
AS
SELECT     B.IdEmpresa, B.IdSucursal, B.IdBodega, B.IdCbteVta, A.IdProducto, SUM(A.dv_cantidad) AS dv_cantidad, B.Estado, B.dv_OtroValor2, B.dv_OtroValor1, B.dv_interes, 
                      B.dv_flete, B.dv_seguro
