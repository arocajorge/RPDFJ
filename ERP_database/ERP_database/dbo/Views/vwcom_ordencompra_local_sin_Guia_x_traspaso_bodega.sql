...
AS
SELECT        OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.oc_fecha, OC.oc_observacion, OC.IdEstadoAprobacion_cat, OC.Estado, OC.IdProveedor, cp_proveedor.pr_nombre AS nom_proveedor, 
...
GROUP BY OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.IdEstadoAprobacion_cat, OC.oc_fecha, OC.oc_observacion, OC.Estado, OC.IdProveedor, cp_proveedor.pr_nombre