...
FROM            dbo.fa_notaCreDeb INNER JOIN
                         ...
                         dbo.fa_cliente ON dbo.fa_notaCreDeb.IdEmpresa = dbo.fa_cliente.IdEmpresa AND dbo.fa_notaCreDeb.IdCliente = dbo.fa_cliente.IdCliente AND 
                         dbo.tb_sucursal.IdEmpresa = dbo.fa_cliente.IdEmpresa AND dbo.tb_sucursal.IdSucursal = dbo.fa_cliente.IdSucursal INNER JOIN
