...
AS
SELECT        dbo.seg_Usuario_x_Empresa.IdUsuario, dbo.seg_Usuario_x_Empresa.IdEmpresa, dbo.seg_Usuario_x_Empresa.Observacion, dbo.tb_empresa.em_nombre, dbo.tb_empresa.em_ruc, dbo.seg_usuario.Nombre
