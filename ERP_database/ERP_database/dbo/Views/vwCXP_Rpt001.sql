...
FROM            (SELECT        dbo.vwcp_orden_giro_total_saldo.IdEmpresa, dbo.vwcp_orden_giro_total_saldo.IdCbteCble_Ogiro, dbo.vwcp_orden_giro_total_saldo.IdTipoCbte_Ogiro, dbo.vwcp_orden_giro_total_saldo.IdOrden_giro_Tipo, 
                                                    ...
                                                    dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.vwcp_orden_giro_total_saldo.co_total AS total, dbo.vwcp_orden_giro_total_saldo.co_total * - 1 AS Valor, 0 AS Valor_debe, 
                          ...
                          SELECT        dbo.vwcp_nota_DebCre_total_saldo.IdEmpresa, dbo.vwcp_nota_DebCre_total_saldo.IdCbteCble_Nota, dbo.vwcp_nota_DebCre_total_saldo.IdTipoCbte_Nota, '05' AS Expr1, nd.cod_nota AS Documento, 
                                                   ...
                                                   dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.vwcp_nota_DebCre_total_saldo.cn_total AS Valor_a_pagar, dbo.vwcp_nota_DebCre_total_saldo.cn_total * - 1, 0 AS Valor_debe, 
                          ...
                          SELECT        dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, dbo.cp_orden_giro.co_factura AS Documento, 
                                                   ...
                                                   dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_orden_giro.co_total, dbo.cp_orden_pago_cancelaciones.MontoAplicado, 
                          ...
                          SELECT        dbo.cp_nota_DebCre.IdEmpresa, dbo.cp_nota_DebCre.IdCbteCble_Nota, dbo.cp_nota_DebCre.IdTipoCbte_Nota, '05' AS Expr1, cp_nota_DebCre.cod_nota AS Documento, 
                                                   ...
                                                   dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_nota_DebCre.cn_total AS Valor_a_pagar, dbo.cp_orden_pago_cancelaciones.MontoAplicado, 
                          ...
                          SELECT        dbo.cp_orden_pago_det.IdEmpresa_cxp, cp_orden_pago_det.IdCbteCble_cxp AS IdCbteCble_Ogiro, cp_orden_pago_det.IdTipoCbte_cxp AS IdTipoCbte_Ogiro, NULL AS IdOrden_giro_Tipo, 
                                                   ...
                                                   dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_orden_pago_det.Valor_a_pagar, dbo.cp_orden_pago_det.Valor_a_pagar * - 1, 0 AS Valor_debe, 
                          ...
                          SELECT        dbo.cp_orden_pago_det.IdEmpresa_cxp, cp_orden_pago_det.IdCbteCble_cxp AS IdCbteCble_Ogiro, cp_orden_pago_det.IdTipoCbte_cxp AS IdTipoCbte_Ogiro, NULL AS IdOrden_giro_Tipo, 
                                                   ...
                                                   dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_orden_pago_det.Valor_a_pagar, dbo.cp_orden_pago_cancelaciones.MontoAplicado, dbo.cp_orden_pago_cancelaciones.MontoAplicado AS Valor_debe, 
                          ...
                          SELECT        dbo.cp_orden_pago_det.IdEmpresa_cxp, cp_orden_pago_det.IdCbteCble_cxp AS IdCbteCble_Ogiro, cp_orden_pago_det.IdTipoCbte_cxp, NULL AS IdOrden_giro_Tipo, 
                                                   ...
                                                   dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_orden_pago_det.Valor_a_pagar AS Valor_a_pagar, dbo.cp_orden_pago_cancelaciones.MontoAplicado, 
                          ...
                          UNION ALL
                          SELECT        dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, dbo.cp_orden_giro.co_factura AS Documento, 
                                                   'Factura' AS nom_tipo_doc, 'FACT' AS cod_tipo_doc, dbo.vwcp_Retencion_valor_total_x_cbte_cxp.fecha, NULL, NULL, dbo.cp_orden_giro.IdProveedor, dbo.cp_proveedor.pr_nombre, 
