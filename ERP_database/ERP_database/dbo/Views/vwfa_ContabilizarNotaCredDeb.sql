create VIEW [dbo].[vwfa_ContabilizarNotaCredDeb]
AS
SELECT        a.IdEmpresa, a.IdSucursal, a.IdBodega, a.IdNota, b.IdCategoria, SUM(a.sc_iva) AS IVA, SUM(a.sc_subtotal) AS SUBTOTAL, SUM(a.sc_total) AS tOTAL, 
                         SUM(a.sc_descUni * a.sc_cantidad) AS descuentototal, a.IdPunto_cargo_grupo, a.IdPunto_Cargo
FROM            dbo.fa_notaCreDeb_det AS a INNER JOIN
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[35] 4[24] 2[24] 3) )"
      End
