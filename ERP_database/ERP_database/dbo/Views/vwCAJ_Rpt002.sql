...
SELECT dbo.caj_Caja_Movimiento.IdEmpresa, dbo.caj_Caja_Movimiento.IdCbteCble, dbo.caj_Caja_Movimiento.IdTipocbte, dbo.ct_cbtecble_tipo.CodTipoCbte AS Tipo_Cbte, dbo.caj_Caja_Movimiento.cm_fecha, dbo.caj_Caja_Movimiento.cm_Signo, 
                  dbo.tb_persona.pe_nombreCompleto, dbo.caj_Caja_Movimiento.cm_observacion, dbo.caj_Caja_Movimiento.Estado, dbo.caj_Caja.IdCaja, dbo.caj_Caja.ca_Descripcion AS nom_caja, dbo.tb_sucursal.IdSucursal, 
                  dbo.tb_sucursal.Su_Descripcion AS nom_sucursal, dbo.caj_Caja_Movimiento_Tipo.IdTipoMovi, dbo.caj_Caja_Movimiento_Tipo.tm_descripcion AS nom_TipoMovi, dbo.tb_empresa.em_nombre AS nom_empresa, 
...
FROM     dbo.caj_Caja_Movimiento INNER JOIN
                  ...
                  dbo.tb_sucursal ON dbo.caj_Caja_Movimiento.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND dbo.caj_Caja_Movimiento.IdSucursal = dbo.tb_sucursal.IdSucursal INNER JOIN
