...
UNION
SELECT        dbo.ba_Archivo_Transferencia_Det.IdEmpresa, dbo.ba_Archivo_Transferencia_Det.IdArchivo, dbo.ba_Archivo_Transferencia_Det.Secuencia, dbo.ba_Archivo_Transferencia_Det.IdProceso_bancario, 
                         dbo.ba_Archivo_Transferencia.Origen_Archivo, per_col.pe_cedulaRuc, dbo.Aca_Documento_Bancario_x_Rep_Economico.Numero_Documento AS num_cta_acreditacion, per_col.pe_nombreCompleto, 
                         dbo.ba_Archivo_Transferencia_Det.Valor, dbo.ba_Archivo_Transferencia_Det.Valor_cobrado, ISNULL(dbo.ba_Archivo_Transferencia_Det.Valor - dbo.ba_Archivo_Transferencia_Det.Valor_cobrado, 0) AS Saldo, 
                         dbo.ba_Archivo_Transferencia_Det.IdEstadoRegistro_cat, dbo.ba_Catalogo.ca_descripcion AS nom_EstadoRegistro_cat, dbo.ba_Archivo_Transferencia_Det.Id_Item, 
                         dbo.ba_Archivo_Transferencia.IdOrden_Bancaria, dbo.ba_Archivo_Transferencia.Fecha, dbo.ba_Archivo_Transferencia.IdBanco, dbo.ba_Archivo_Transferencia_Det.Secuencial_reg_x_proceso, 
                         dbo.ba_Archivo_Transferencia_Det.IdEmpresa_pago, dbo.ba_Archivo_Transferencia_Det.IdTipoCbte_pago, dbo.ba_Archivo_Transferencia_Det.IdCbteCble_pago, dbo.ct_cbtecble.cb_Estado, 
                         dbo.Aca_Pre_Facturacion_det.IdEmpresa_fac, dbo.Aca_Pre_Facturacion_det.IdSucursal_fac, dbo.Aca_Pre_Facturacion_det.IdBodega_fac, dbo.Aca_Pre_Facturacion_det.IdCbteVta_fac, 
                         dbo.Aca_estudiante.cod_estudiante2, dbo.ba_Archivo_Transferencia_Det.IdInstitucion_contrato, dbo.ba_Archivo_Transferencia_Det.idContrato, dbo.ba_Archivo_Transferencia_Det.IdEmpresaNomina, 
                         dbo.ba_Archivo_Transferencia_Det.IdNominaTipo, dbo.ba_Archivo_Transferencia_Det.IdNominaTipoLiqui, dbo.ba_Archivo_Transferencia_Det.IdPeriodo, dbo.ba_Archivo_Transferencia_Det.IdRubro, 
                         dbo.ba_Archivo_Transferencia_Det.IdEmpleado
FROM            dbo.tb_persona AS per_col INNER JOIN
                         ...
                         dbo.Aca_Pre_Facturacion_det.IdEstudiante = dbo.Aca_Familiar_x_Estudiante.IdEstudiante AND dbo.Aca_Pre_Facturacion_det.IdFamiliar = dbo.Aca_Familiar_x_Estudiante.IdFamiliar AND 
                         ...
                         dbo.Aca_estudiante ON dbo.Aca_Familiar_x_Estudiante.IdInstitucion = dbo.Aca_estudiante.IdInstitucion AND dbo.Aca_Familiar_x_Estudiante.IdEstudiante = dbo.Aca_estudiante.IdEstudiante ON 
                         per_col.IdPersona = dbo.Aca_estudiante.IdPersona INNER JOIN
                         dbo.ba_Catalogo INNER JOIN
                         dbo.ba_Archivo_Transferencia_Det INNER JOIN
                         dbo.ba_Archivo_Transferencia ON dbo.ba_Archivo_Transferencia_Det.IdEmpresa = dbo.ba_Archivo_Transferencia.IdEmpresa AND 
                         dbo.ba_Archivo_Transferencia_Det.IdArchivo = dbo.ba_Archivo_Transferencia.IdArchivo ON dbo.ba_Catalogo.IdCatalogo = dbo.ba_Archivo_Transferencia_Det.IdEstadoRegistro_cat ON 
                         ...
                         dbo.Aca_Documento_Bancario_x_Rep_Economico.IdDocumento_Bancario = dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula.IdDocumento_Bancario ON 
                         dbo.Aca_Familiar_x_Estudiante.IdInstitucion = dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula.IdInstitucion AND 
...
SELECT        dbo.ba_Archivo_Transferencia_Det.IdEmpresa, dbo.ba_Archivo_Transferencia_Det.IdArchivo, dbo.ba_Archivo_Transferencia_Det.Secuencia, dbo.ba_Archivo_Transferencia_Det.IdProceso_bancario, 
                         ...
                         dbo.ba_Archivo_Transferencia_Det.IdEstadoRegistro_cat, dbo.ba_Catalogo.ca_descripcion AS nom_EstadoRegistro_cat, dbo.ba_Archivo_Transferencia_Det.Id_Item, 
                         dbo.ba_Archivo_Transferencia.IdOrden_Bancaria, dbo.ba_Archivo_Transferencia.Fecha, dbo.ba_Archivo_Transferencia.IdBanco, dbo.ba_Archivo_Transferencia_Det.Secuencial_reg_x_proceso, 
                         dbo.ba_Archivo_Transferencia_Det.IdEmpresa_pago, dbo.ba_Archivo_Transferencia_Det.IdTipoCbte_pago, dbo.ba_Archivo_Transferencia_Det.IdCbteCble_pago, dbo.ct_cbtecble.cb_Estado, NULL AS Expr1, NULL 
                         AS dSucursal_fac, NULL AS Expr2, NULL AS Expr3, dbo.Aca_estudiante.cod_estudiante2, dbo.ba_Archivo_Transferencia_Det.IdInstitucion_contrato, dbo.ba_Archivo_Transferencia_Det.idContrato, 
                         dbo.ba_Archivo_Transferencia_Det.IdEmpresaNomina, dbo.ba_Archivo_Transferencia_Det.IdNominaTipo, dbo.ba_Archivo_Transferencia_Det.IdNominaTipoLiqui, dbo.ba_Archivo_Transferencia_Det.IdPeriodo, 
                         dbo.ba_Archivo_Transferencia_Det.IdRubro, dbo.ba_Archivo_Transferencia_Det.IdEmpleado
FROM            dbo.Aca_Documento_Bancario_x_Rep_Economico INNER JOIN
                         dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula ON 
                         dbo.Aca_Documento_Bancario_x_Rep_Economico.IdInstitucion = dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula.IdInstitucion AND 
                         dbo.Aca_Documento_Bancario_x_Rep_Economico.IdFamiliar = dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula.IdFamiliar AND 
                         dbo.Aca_Documento_Bancario_x_Rep_Economico.IdParentesco_cat = dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula.IdParentesco_cat AND 
                         dbo.Aca_Documento_Bancario_x_Rep_Economico.IdDocumento_Bancario = dbo.Aca_Documento_Bancario_x_Rep_Economico_x_estudiante_x_Matricula.IdDocumento_Bancario RIGHT OUTER JOIN
                         ...
                         dbo.Aca_estudiante ON dbo.Aca_Familiar_x_Estudiante.IdInstitucion = dbo.Aca_estudiante.IdInstitucion AND dbo.Aca_Familiar_x_Estudiante.IdEstudiante = dbo.Aca_estudiante.IdEstudiante ON 
                         per_col.IdPersona = dbo.Aca_estudiante.IdPersona ON dbo.Aca_Contrato_x_Estudiante.IdInstitucion = dbo.Aca_estudiante.IdInstitucion AND 
                         dbo.Aca_Contrato_x_Estudiante.IdEstudiante = dbo.Aca_estudiante.IdEstudiante ON dbo.ct_cbtecble.IdEmpresa = dbo.ba_Archivo_Transferencia_Det.IdEmpresa_pago AND 
                         dbo.ct_cbtecble.IdTipoCbte = dbo.ba_Archivo_Transferencia_Det.IdTipoCbte_pago AND dbo.ct_cbtecble.IdCbteCble = dbo.ba_Archivo_Transferencia_Det.IdCbteCble_pago ON 
