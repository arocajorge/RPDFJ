...
FROM            dbo.tb_sucursal INNER JOIN
                         ...
                         dbo.cp_proveedor ON dbo.Af_Activo_fijo.IdEmpresa = dbo.cp_proveedor.IdEmpresa AND dbo.Af_Activo_fijo.IdProveedor = dbo.cp_proveedor.IdProveedor ON 
