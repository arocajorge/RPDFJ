...
SELECT        dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, 
                         ...
                         dbo.cp_TipoDocumento.Codigo AS cod_tipo_doc, dbo.cp_orden_giro.co_fechaOg, dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.pr_nombre AS nom_proveedor, 
...
SELECT        dbo.cp_nota_DebCre.IdEmpresa, dbo.cp_nota_DebCre.IdCbteCble_Nota, dbo.cp_nota_DebCre.IdTipoCbte_Nota, 
                         ...
                         dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.cp_nota_DebCre.cn_total AS Valor_a_pagar, 0 AS Valor_debe, 
