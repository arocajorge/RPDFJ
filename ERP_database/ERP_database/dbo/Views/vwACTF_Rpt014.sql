...
SELECT        dbo.Af_Activo_fijo.IdEmpresa, dbo.Af_Depreciacion.IdPeriodo, dbo.Af_Tipo_Depreciacion.nom_tipo_depreciacion, SUM(dbo.Af_Activo_fijo.Af_costo_compra) 
                         ...
                         AVG(dbo.Af_Depreciacion_Det.Porc_Depreciacion) AS Porc_Depreciacion, dbo.Af_Activo_fijo.IdActijoFijoTipo, 
...
GROUP BY dbo.Af_Activo_fijo.IdEmpresa, dbo.Af_Depreciacion.IdPeriodo, dbo.Af_Tipo_Depreciacion.nom_tipo_depreciacion, dbo.Af_Activo_fijo.IdActijoFijoTipo, 
