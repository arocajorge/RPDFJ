...
SELECT        A.IdProveedor, A.co_fechaOg, A.co_observacion, A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, AVG(A.co_valorpagar) AS valorAPagar, 
                         ISNULL(SUM(B.MontoAplicado), 0) AS TotalPagado, AVG(A.co_valorpagar) - ISNULL(SUM(B.MontoAplicado), 0) AS saldo, P.pr_nombre AS Proveedor, 
                         A.co_factura AS NFactura, P.pr_girar_cheque_a AS GiraCheque, P.IdCtaCble_CXP AS CtaProveedor
...
WHERE        (A.Estado = 'A')
GROUP BY A.IdProveedor, A.co_fechaOg, A.co_observacion, A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, A.co_valorpagar, P.pr_nombre, A.co_factura, 
                         P.pr_girar_cheque_a, P.IdCtaCble_CXP
GO
