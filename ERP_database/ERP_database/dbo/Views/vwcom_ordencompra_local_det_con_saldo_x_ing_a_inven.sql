...
SELECT        dbo.com_ordencompra_local.IdEmpresa, dbo.com_ordencompra_local.IdSucursal, dbo.com_ordencompra_local.IdOrdenCompra, 
                         ...
                         dbo.cp_proveedor.pr_nombre AS nom_proveedor, dbo.com_ordencompra_local.Tipo, dbo.com_ordencompra_local.oc_fecha, 
                         ...
                         dbo.com_Motivo_Orden_Compra.Descripcion AS Nom_Motivo, NULL AS Referencia, dbo.in_Ing_Egr_Inven.IdMotivo_oc, 
...
FROM            dbo.in_Ing_Egr_Inven INNER JOIN
                         ...
                         dbo.in_Ing_Egr_Inven_det.secuencia_inv = dbo.in_movi_inve_detalle.Secuencia
GO
