...
AS
SELECT        dpr.IdEmpresa, dpr.IdDepreciacion, dpr.IdTipoDepreciacion, dpr.Cod_Depreciacion, dpr.IdPeriodo, af.IdActivoFijo, af.IdActijoFijoTipo, af.Af_Nombre, 
                         tip.Af_Descripcion, dpr.Descripcion, dpr.Fecha_Depreciacion, tde.cod_tipo_depreciacion, ddt.Valor_Depreciacion
FROM            dbo.Af_Depreciacion AS dpr INNER JOIN
                         ...
                         dbo.Af_Activo_fijo_tipo AS tip ON tip.IdEmpresa = af.IdEmpresa AND tip.IdActijoFijoTipo = af.IdActijoFijoTipo INNER JOIN
                         dbo.Af_Tipo_Depreciacion AS tde ON tde.IdTipoDepreciacion = af.IdTipoDepreciacion
GO
