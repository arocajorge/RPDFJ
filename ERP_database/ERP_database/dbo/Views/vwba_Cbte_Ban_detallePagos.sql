...
, og.IdProveedor, 
                      og_p.IdCbteCble_pago IdCbteCble_cbte, og_p.IdTipoCbte_pago IdTipocbte_cbte, og.IdTipoCbte_Ogiro, og.co_factura AS NFactura, p.pr_nombre AS Proveedor, p.pr_girar_cheque_a AS GiraCheque, 
