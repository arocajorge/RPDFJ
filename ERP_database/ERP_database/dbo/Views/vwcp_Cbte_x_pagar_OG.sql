...
SELECT     A.IdEmpresa, EM.em_nombre, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, A.IdProveedor, P.pr_nombre AS NomProveedor, A.co_fechaOg, A.co_factura, 
...
GROUP BY A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, A.IdProveedor, A.co_fechaOg, A.co_factura, A.co_observacion, A.co_serie, P.pr_nombre, EM.em_nombre, 
...
SELECT     cp_nota_DebCre.IdEmpresa, EM.em_nombre, cp_nota_DebCre.IdCbteCble_Nota
						...
						, cp_nota_DebCre.IdProveedor, 
                         P.pr_nombre AS NomProveedor, cp_nota_DebCre.cn_fecha
						 ,case 
...
FROM            tb_empresa AS EM INNER JOIN
                         ...
                         cp_TipoDocumento
GROUP BY P.pr_nombre, EM.em_nombre, cp_nota_DebCre.IdEmpresa, cp_nota_DebCre.IdCbteCble_Nota, cp_nota_DebCre.IdTipoCbte_Nota, cp_nota_DebCre.IdProveedor, 
