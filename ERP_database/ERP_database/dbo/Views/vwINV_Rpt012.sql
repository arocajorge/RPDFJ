...
SELECT        movIn.IdEmpresa, movIn.IdSucursal, movIn.IdBodega, movIn.IdMovi_inven_tipo, movIn.IdNumMovi, movInDet.Secuencia, suc.Su_Descripcion, bod.bo_Descripcion, 
                         ...
                         movInDet.dm_cantidad, movInDet.dm_stock_actu, movInDet.dm_stock_ante, movInDet.dm_observacion, movInDet.mv_costo,in_Ing_Egr_Inven_det.dm_precio, movInDet.dm_peso, cat.IdCategoria, 
						 ...
						 isnull(in_Ing_Egr_Inven_det.dm_precio * abs(in_Ing_Egr_Inven_det.dm_cantidad),0) as total_precio
