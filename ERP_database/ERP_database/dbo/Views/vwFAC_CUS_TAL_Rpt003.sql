...
SELECT        guia.IdEmpresa, guia.IdSucursal, guia.IdBodega, guia.IdGuiaRemision, guia.CodGuiaRemision, guia.Serie1, guia.Serie2, guia.NumGuia_Preimpresa, guia.IdCliente, 
                         guia.IdVendedor, guia.IdTransportista, guia.gi_fecha, guia.gi_plazo, guia.gi_fech_venc, guia.gi_Observacion, guia.gi_TotalKilos, guia.gi_TotalQuintales, 
                         guia.IdUsuario, guia.gi_flete, guia.gi_interes, guia.gi_seguro, guia.gi_OtroValor1, guia.gi_OtroValor2, gui_det.Secuencia, gui_det.IdProducto, gui_det.gi_cantidad, 
                         gui_det.gi_Precio, gui_det.gi_PorDescUnitario, gui_det.gi_DescUnitario, gui_det.gi_PrecioFinal, gui_det.gi_Subtotal, gui_det.gi_iva, gui_det.gi_total, 
                         gui_det.gi_detallexItems, gui_det.gi_peso, emp.em_nombre AS nom_empresa, emp.em_ruc AS ruc_empresa, emp.em_logo AS logo_empresa, 
