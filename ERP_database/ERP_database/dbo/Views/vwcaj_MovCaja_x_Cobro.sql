...
SELECT        dbo.caj_Caja_Movimiento.IdEmpresa, dbo.caj_Caja_Movimiento.IdCbteCble, dbo.caj_Caja_Movimiento.IdTipocbte, dbo.cxc_cobro.IdBanco, dbo.cxc_cobro.IdCaja, 
                         ...
                         dbo.tb_sucursal.Su_Descripcion AS nSucursal, dbo.tb_persona.pe_nombreCompleto AS nCliente, '' AS Documento_Cobrado
FROM            dbo.caj_Caja_Movimiento INNER JOIN
                         ...
                         dbo.tb_sucursal ON dbo.caj_Caja_Movimiento.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND dbo.caj_Caja_Movimiento.IdSucursal = dbo.tb_sucursal.IdSucursal AND 
                         dbo.cxc_cobro_det.IdEmpresa = dbo.tb_sucursal.IdEmpresa AND dbo.cxc_cobro_det.IdSucursal = dbo.tb_sucursal.IdSucursal INNER JOIN
