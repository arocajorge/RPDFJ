...
FROM            (SELECT        A.IdEmpresa, A.IdTipo_op, SUBSTRING(D .Descripcion, 1, 3) + '#' + C.co_serie + ' -' + C.co_factura AS Referencia, SUBSTRING(D .Descripcion, 1, 3) + '#' + CAST(CAST(C.co_factura AS NUMERIC) AS VARCHAR) 
                                                    ...
                                                    C.co_FechaFactura_vct AS Fecha_Venc_Fac_Prov, A.Observacion, Pr.pr_nombre AS Nom_Beneficiario, Pr.pr_girar_cheque_a AS Girar_Cheque_a, C.co_valorpagar AS Valor_a_pagar, 
                                                    ...
                                                    A.Estado, '[PROVEE]' + '[' + CAST(Pr.IdPersona AS varchar(20)) + ']' + '[' + CAST(C.IdProveedor AS varchar(20)) + ']' + Pr.pr_nombre AS Nom_Beneficiario_2, C.IdEmpresa AS IdEmpresa_cxp, 
                          ...
                          SELECT        A.IdEmpresa, A.IdTipo_op, 'ND' + '#' + cast(cp_nota_DebCre.IdCbteCble_Nota AS varchar(20)) + cp_nota_DebCre.cn_observacion AS Referencia, CASE WHEN cp_nota_DebCre.cod_nota IS NULL 
                                                   ...
                                                   A.Observacion, Pr.pr_nombre AS Nom_Beneficiario, Pr.pr_girar_cheque_a AS Girar_Cheque_a, cp_nota_DebCre.cn_total Valor_a_pagar, B.Valor_a_pagar AS Valor_estimado_a_pagar_OP, 
                                                   ...
                                                   Pr.pr_nombre nom_beneficiario2, cp_nota_DebCre.IdEmpresa, cp_nota_DebCre.IdTipoCbte_Nota, cp_nota_DebCre.IdCbteCble_Nota, A.IdBanco
                          ...
                          SELECT        C.IdEmpresa, 'FACT_PROVEE' AS IdTipo_op, SUBSTRING(D .Descripcion, 1, 3) + '#' + C.co_serie + ' -' + C.co_factura AS Referencia, 'FA#:' + CAST(CAST(C.co_factura AS NUMERIC) AS VARCHAR(20)) 
                                                   ...
                                                   C.co_FechaFactura_vct AS Fecha_Venc_Fac_Prov, C.co_observacion, Pr.pr_nombre AS Nom_Beneficiario, Pr.pr_girar_cheque_a AS Girar_Cheque_a, C.co_valorpagar AS Valor_a_pagar, 
                                                   ...
                                                   C.IdCbteCble_Ogiro AS Cbte_cxp, C.Estado, '[PROVEE]' + '[' + CAST(Pr.IdPersona AS varchar(20)) + ']' + '[' + CAST(C.IdProveedor AS varchar(20)) + ']' + Pr.pr_nombre AS Nom_Beneficiario_2, 
