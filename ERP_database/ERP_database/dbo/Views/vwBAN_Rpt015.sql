...
SELECT        dbo.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito.mba_IdEmpresa, dbo.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito.mba_IdCbteCble, 
                         ...
                         dbo.caj_Caja_Movimiento.IdEmpresa, dbo.tb_sucursal.Su_Descripcion AS nom_sucursal, dbo.caj_Caja_Movimiento.IdCbteCble, 
                         dbo.caj_Caja_Movimiento.IdTipocbte, dbo.ct_cbtecble_tipo.tc_TipoCbte AS nom_Tipocbte, dbo.caj_Caja_Movimiento.cm_beneficiario AS Beneficiario, 
                         dbo.caj_Caja_Movimiento_det.IdCobro_tipo, dbo.caj_Caja_Movimiento_det.cr_fecha AS Fecha_Cobro, CASE WHEN dbo.caj_Caja_Movimiento_det.cr_Valor IS NULL 
...
FROM            dbo.caj_Caja_Movimiento_det INNER JOIN
                         ...
                         dbo.caj_Caja_Movimiento.IdSucursal = dbo.tb_sucursal.IdSucursal
WHERE        (dbo.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito.mba_IdEmpresa = 15) AND (dbo.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito.mba_IdCbteCble = 41) AND 
                         (dbo.ba_Caja_Movimiento_x_Cbte_Ban_x_Deposito.mba_IdTipocbte = 3)
GO
