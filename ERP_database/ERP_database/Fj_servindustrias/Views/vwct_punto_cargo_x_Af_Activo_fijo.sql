...
SELECT ct_punto_cargo.IdEmpresa, ct_punto_cargo.IdPunto_cargo, ct_punto_cargo.codPunto_cargo, ct_punto_cargo.nom_punto_cargo, ct_punto_cargo.Estado, ct_punto_cargo.IdPunto_cargo_grupo, 
                  Af_Activo_fijo.IdCentroCosto AS IdCentroCosto_Scc, Af_Activo_fijo.IdCentroCosto_sub_centro_costo AS IdCentroCosto_sub_centro_costo_Scc, ct_centro_costo.Centro_costo AS nom_centro, 
...
FROM     ct_punto_cargo INNER JOIN
                  ...
                  ct_centro_costo ON Af_Activo_fijo.IdEmpresa = ct_centro_costo.IdEmpresa AND Af_Activo_fijo.IdCentroCosto = ct_centro_costo.IdCentroCosto LEFT OUTER JOIN
                  ct_centro_costo_sub_centro_costo ON Af_Activo_fijo.IdEmpresa = ct_centro_costo_sub_centro_costo.IdEmpresa AND Af_Activo_fijo.IdCentroCosto = ct_centro_costo_sub_centro_costo.IdCentroCosto AND 
                  Af_Activo_fijo.IdCentroCosto_sub_centro_costo = ct_centro_costo_sub_centro_costo.IdCentroCosto_sub_centro_costo
WHERE  Af_Activo_fijo.Es_carroceria = 0
UNION
