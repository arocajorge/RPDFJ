...
as
SELECT        dbo.tb_persona.pe_razonSocial, dbo.tb_persona.pe_cedulaRuc, dbo.tb_persona.pe_direccion, dbo.tb_persona.pe_telefonoOfic, dbo.tb_persona.pe_telefonoCasa, 
                         ...
                         fa_cliente_x_ct_centro_costo_1.IdEmpresa_cli, dbo.fa_cliente.IdActividadComercial, dbo.fa_cliente.Estado, dbo.vwtb_Ciudad.IdProvincia, dbo.vwtb_Ciudad.IdPais, 
                         dbo.vwtb_Ciudad.Descripcion_Ciudad, dbo.ct_centro_costo.Centro_costo AS nom_Centro_costo, dbo.tb_persona.pe_nombreCompleto AS nom_Cliente, 
