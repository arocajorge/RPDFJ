CREATE VIEW Fj_servindustrias.vwFAC_FJ_Rpt001
AS
SELECT Fj_servindustrias.fa_orden_trabajo_plataforma.IdEmpresa, Fj_servindustrias.fa_orden_trabajo_plataforma.IdOrdenTrabajo_Pla, Fj_servindustrias.fa_orden_trabajo_plataforma.codOrdenTrabajo_Pla, 
                  ...
                  Fj_servindustrias.fa_orden_trabajo_plataforma_det.secuencia, Fj_servindustrias.fa_orden_trabajo_plataforma_det.descrip_equipo_movi, Fj_servindustrias.fa_orden_trabajo_plataforma_det.punto_partida, 
                  Fj_servindustrias.fa_orden_trabajo_plataforma_det.punto_llegada, Fj_servindustrias.fa_orden_trabajo_plataforma_det.hora_ini, Fj_servindustrias.fa_orden_trabajo_plataforma_det.hora_fin, 
                  Fj_servindustrias.fa_orden_trabajo_plataforma_det.Valor, Fj_servindustrias.fa_orden_trabajo_plataforma.vt_num_factura, dbo.ct_punto_cargo.nom_punto_cargo, dbo.ct_punto_cargo.IdPunto_cargo, 
                  Fj_servindustrias.fa_orden_trabajo_plataforma.IdTransportista, Fj_servindustrias.fa_orden_trabajo_plataforma.IdVendedor, dbo.fa_Vendedor.Ve_Vendedor, dbo.tb_transportista.Nombre
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'Fj_servindustrias', @level1type = N'VIEW', @level1name = N'vwFAC_FJ_Rpt001';
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "tb_transportista"
            Begin Extent = 
               Top = 7
               Left = 10', @level0type = N'SCHEMA', @level0name = N'Fj_servindustrias', @level1type = N'VIEW', @level1name = N'vwFAC_FJ_Rpt001';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'77
               Bottom = 184
               Right = 1294
            End
            DisplayFlags = 280
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'Fj_servindustrias', @level1type = N'VIEW', @level1name = N'vwFAC_FJ_Rpt001';
