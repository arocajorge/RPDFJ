...
AS
SELECT        dbo.Af_Activo_fijo.IdEmpresa, dbo.Af_Activo_fijo.IdActivoFijo, dbo.Af_Activo_fijo.IdCategoriaAF, dbo.Af_Catalogo.Descripcion AS Marca, dbo.Af_Activo_fijo.Af_Capacidad, tb_modelo.Descripcion AS Modelo, 
                         ...
                         dbo.Af_Activo_fijo.Af_Fecha_Venta, dbo.ba_prestamo.Observacion AS Operacion, dbo.Af_Activo_fijo.Af_NumSerie_Chasis, dbo.ba_prestamo.Fecha, dbo.Af_Activo_fijo.Af_DescripcionCorta
FROM            dbo.cp_orden_giro RIGHT OUTER JOIN
                         ...
                         dbo.cp_orden_giro.IdEmpresa = dbo.Af_Activo_fijo.IdEmpresa_Ogiro AND dbo.cp_orden_giro.IdCbteCble_Ogiro = dbo.Af_Activo_fijo.IdCbteCble_Ogiro AND 
