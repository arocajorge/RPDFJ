...
SELECT        Fj_servindustrias.Af_Activo_fijo_x_ct_centro_costo_sub_centro_costo.IdEmpresa_AF, dbo.ct_centro_costo_sub_centro_costo.IdCentroCosto_sub_centro_costo, 
                         ...
                         dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo, dbo.Af_Activo_fijo.IdActivoFijo, dbo.Af_Activo_fijo_Categoria.Descripcion AS Categoria, 
...
FROM            dbo.ct_centro_costo_sub_centro_costo INNER JOIN
                         ...
                         dbo.Af_Activo_fijo.IdActijoFijoTipo = dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo AND dbo.Af_Activo_fijo.IdEmpresa = dbo.Af_Activo_fijo_tipo.IdEmpresa AND 
                         dbo.Af_Activo_fijo.IdActijoFijoTipo = dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo AND dbo.Af_Activo_fijo_Categoria.IdEmpresa = dbo.Af_Activo_fijo_tipo.IdEmpresa AND 
                         dbo.Af_Activo_fijo_Categoria.IdActivoFijoTipo = dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo AND 
                         dbo.Af_Activo_fijo_Categoria.IdEmpresa = dbo.Af_Activo_fijo_tipo.IdEmpresa AND 
                         dbo.Af_Activo_fijo_Categoria.IdActivoFijoTipo = dbo.Af_Activo_fijo_tipo.IdActijoFijoTipo
