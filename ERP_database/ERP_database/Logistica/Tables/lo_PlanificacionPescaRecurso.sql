CREATE TABLE [Logistica].[lo_PlanificacionPescaRecurso] (
    ...
    CONSTRAINT [FK_lo_PlanificacionPescaRecurso_lo_PlanificacionPesca] FOREIGN KEY ([IdPlanificacion]) REFERENCES [Logistica].[lo_PlanificacionPesca] ([IdPlanificacion]),
