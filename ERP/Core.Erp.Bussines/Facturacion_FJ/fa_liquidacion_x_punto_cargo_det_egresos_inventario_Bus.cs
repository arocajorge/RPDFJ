...
{
    public class fa_liquidacion_x_punto_cargo_det_egresos_inventario_Bus
    {
        fa_liquidacion_x_punto_cargo_det_egresos_inventario_Data oData = new fa_liquidacion_x_punto_cargo_det_egresos_inventario_Data();

        public List<fa_liquidacion_x_punto_cargo_det_egresos_inventario_Info> get_list(int IdEmpresa, int IdSucursal, string IdCentrCosto, decimal IdLiquidacion)
        {
            try
            {
