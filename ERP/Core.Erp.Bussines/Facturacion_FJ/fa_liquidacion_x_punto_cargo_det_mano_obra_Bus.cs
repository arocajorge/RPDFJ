...
{    
    public class fa_liquidacion_x_punto_cargo_det_mano_obra_Bus
    {
        fa_liquidacion_x_punto_cargo_det_mano_obra_Data oData = new fa_liquidacion_x_punto_cargo_det_mano_obra_Data();

        public List<fa_liquidacion_x_punto_cargo_det_mano_obra_Info> get_list(int IdEmpresa, int IdSucursal, string IdCentrCosto, decimal IdLiquidacion)
        {
            try
            {
