...
{
    public class fa_liquidacion_x_punto_cargo_det_mano_obra_det_Bus
    {
        fa_liquidacion_x_punto_cargo_det_mano_obra_det_Data oData = new fa_liquidacion_x_punto_cargo_det_mano_obra_det_Data();

        public List<fa_liquidacion_x_punto_cargo_det_mano_obra_det_Info> get_list(int IdEmpresa, int IdSucursal, string IdCentrCosto, decimal IdLiquidacion, int mo_secuencia)
        {
            try
            {
                return oData.get_list(IdEmpresa, IdSucursal, IdCentrCosto, IdLiquidacion,mo_secuencia);
            }
            catch (Exception ex)
            {
