...
{
    public class fa_liquidacion_x_punto_cargo_det_ingresos_consumo_directo_Bus
    {
        fa_liquidacion_x_punto_cargo_det_ingresos_consumo_directo_Data oData = new fa_liquidacion_x_punto_cargo_det_ingresos_consumo_directo_Data();

        public List<fa_liquidacion_x_punto_cargo_det_ingresos_consumo_directo_Info> get_list(int IdEmpresa, int IdSucursal, string IdCentrCosto, decimal IdLiquidacion)
        {
            try
            {
                return oData.get_list(IdEmpresa, IdSucursal, IdCentrCosto, IdLiquidacion);
            }
            catch (Exception ex)
            {
        ...
        public List<fa_liquidacion_x_punto_cargo_det_ingresos_consumo_directo_Info> get_list(int IdPunto_cargo, string cod_orden_mantenimiento, int IdEmpresa, int IdSucursal, string IdCentroCosto, decimal IdLiquidacion)
        {
            try
            {
                return oData.get_list(IdPunto_cargo, cod_orden_mantenimiento, IdEmpresa, IdSucursal, IdCentroCosto, IdLiquidacion);
            }
            catch (Exception ex)
            {
                string mensaje = ex.ToString();
