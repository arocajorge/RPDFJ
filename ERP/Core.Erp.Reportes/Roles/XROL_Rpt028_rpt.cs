...
{
    public partial class XROL_Rpt028_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            XROL_Rpt028_Bus oReporteBus = new XROL_Rpt028_Bus();
            List<XROL_Rpt028_Info> oListado = new List<XROL_Rpt028_Info>();
            ...
            oListado = oReporteBus.GetLista(param.IdEmpresa, idNominaTipo, fechaInicio, fechaFin);
