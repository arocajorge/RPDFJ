...
{
    public partial class XCXC_Rpt020_frm : Form
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance; 


        public XCXC_Rpt020_frm()
        {
            InitializeComponent();
        }
        ...
        private void uccxC_MenuReportes1_event_btnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                XCXC_Rpt020_Rpt rpt = new XCXC_Rpt020_Rpt();
        ...
        private void XCXC_Rpt020_frm_Load(object sender, EventArgs e)
        {
            try
            {
