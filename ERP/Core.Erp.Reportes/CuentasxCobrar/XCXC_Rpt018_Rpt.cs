...
{
    public partial class XCXC_Rpt018_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        XCXC_Rpt018_Bus bus_rpt = new XCXC_Rpt018_Bus();
        List<XCXC_Rpt018_Info> lst_rpt = new List<XCXC_Rpt018_Info>();

        public XCXC_Rpt018_Rpt()
        {
            InitializeComponent();
        }

        private void XCXC_Rpt018_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                lst_rpt = bus_rpt.get_list(param.IdEmpresa, IdCliente, no_mostrar_saldo_0, mostrar_anuladas, Fecha_corte);
