...
{
    public partial class XCXC_Rpt019_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        XCXC_Rpt019_Bus bus_rpt = new XCXC_Rpt019_Bus();
        List<XCXC_Rpt019_Info> lst_rpt = new List<XCXC_Rpt019_Info>();

        public XCXC_Rpt019_Rpt()
        {
            InitializeComponent();
        }

        private void XCXC_Rpt019_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
