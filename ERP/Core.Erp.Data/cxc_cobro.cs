...
namespace Core.Erp.Data
{
    ...
    public partial class cxc_cobro
    {
        public cxc_cobro()
        {
            ...
            this.cxc_cobro_x_ct_cbtecble_x_Anulado = new HashSet<cxc_cobro_x_ct_cbtecble_x_Anulado>();
            this.cxc_cobro_x_EstadoCobro = new HashSet<cxc_cobro_x_EstadoCobro>();
            this.cxc_cobro_x_tarjeta = new HashSet<cxc_cobro_x_tarjeta>();
        ...
        public virtual ICollection<cxc_cobro_x_ct_cbtecble_x_Anulado> cxc_cobro_x_ct_cbtecble_x_Anulado { get; set; }
        public virtual ICollection<cxc_cobro_x_EstadoCobro> cxc_cobro_x_EstadoCobro { get; set; }
        public virtual ICollection<cxc_cobro_x_tarjeta> cxc_cobro_x_tarjeta { get; set; }
