...
namespace Core.Erp.Data.Academico
{
    ...
    public partial class vwAca_Familiar_x_Estudiante
    {
        ...
        public int esta_autorizado_recibir_not_mail { get; set; }
        public int esta_autorizado_ret_alum { get; set; }
        public string Calle_Principal { get; set; }
        public string Calle_Secundaria { get; set; }
        public Nullable<int> Fallecido { get; set; }
        public Nullable<int> FueExAlumnoGraduado { get; set; }
        ...
        public Nullable<int> PoseeDiscapacidad { get; set; }
        public string Sector_Urbanizacion { get; set; }
        public Nullable<int> ViveFueraDelPais { get; set; }
        public string IdCiudad { get; set; }
        public int Vive_con_el_estudiante { get; set; }
