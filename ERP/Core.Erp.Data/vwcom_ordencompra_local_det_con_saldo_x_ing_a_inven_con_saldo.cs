...
namespace Core.Erp.Data
{
    ...
    public partial class vwcom_ordencompra_local_det_con_saldo_x_ing_a_inven_con_saldo
    {
        ...
        public Nullable<double> Saldo_OC_x_Ing { get; set; }
        public Nullable<double> pr_stock { get; set; }
        public int pr_peso { get; set; }
