...
{
    public partial class FrmAca_Asignacion_Masiva_Excepciones_x_Rubro_x_Periodo_x_Estudiante : Form
    {
        #region "Variables"
        string mensaje = "";
        ...
        public FrmAca_Asignacion_Masiva_Excepciones_x_Rubro_x_Periodo_x_Estudiante()
        {
            InitializeComponent();
        }
        ...
        private void FrmAca_Asignacion_Masiva_Excepciones_x_Rubro_x_Periodo_x_Estudiante_Load(object sender, EventArgs e)
        {
