...
{
    public partial class frmRo_Efectividad_entrega_servicios_cosul : Form
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        ro_fectividad_Entrega_servicio_Info info = new ro_fectividad_Entrega_servicio_Info();
        List<ro_fectividad_Entrega_servicio_Info> lista = new List<ro_fectividad_Entrega_servicio_Info>();
        ro_fectividad_Entrega_servicio_Bus bus_efectivida = new ro_fectividad_Entrega_servicio_Bus();
        public frmRo_Efectividad_entrega_servicios_cosul()
        {
            InitializeComponent();
        }
        ...
        public void Buscar()
        {
            try
            {
                lista = bus_efectivida.get_list(param.IdEmpresa, ucGe_Menu.fecha_desde, ucGe_Menu.fecha_hasta);
