...
{
    public partial class frmRo_Calculo_Pago_Variable_Porcentaje_servicio_mant : Form
    {
        ...
        ro_Calculo_Pago_Variable_Porcentaje_servicio_Bus Bus_Calculo = new ro_Calculo_Pago_Variable_Porcentaje_servicio_Bus();
        ro_Calculo_Pago_Variable_Porcentaje_servicio_Info Info_Calculo = new ro_Calculo_Pago_Variable_Porcentaje_servicio_Info();
        ...
        BindingList<ro_Calculo_Pago_Variable_Porcentaje_servicio_Info> Bind_Lista_Calculo = new BindingList<ro_Calculo_Pago_Variable_Porcentaje_servicio_Info>();
        ...
        void Cargar_Combos()
        {
            try
            {
                ...
                //gc_ro_Calculo_Pago_Variable_Porcentaje_servicio.DataSource = Bind_Lista_Calculo;
            }
            catch (Exception ex)
            {
        ...
        void Get_Info()
        {
            try
            {
                Lista_Calculo = new List<ro_Calculo_Pago_Variable_Porcentaje_servicio_Info>();
        ...
        Boolean Grabar()
        {
            try
            {
                if (cmb_tipo_nomina.EditValue != null)
                {
                    ...
                    Bus_Calculo.GuardarDB(Bind_Lista_Calculo.ToList(),Convert.ToInt32(cmb_tipo_nomina.EditValue),param.IdEmpresa);
        ...
        public frmRo_Calculo_Pago_Variable_Porcentaje_servicio_mant()
        {
            InitializeComponent();
        }

        private void frmRo_Calculo_Pago_Variable_Porcentaje_servicio_mant_Load(object sender, EventArgs e)
        {
            try
            {
               // cmb_tipo_nomina.Properties.ReadOnly = true;
                cmb_servicios.Properties.ReadOnly = true;
                ...
                List_NominaTipo = Bus_NominaTipo.Get_List_Nomina_Tipo(param.IdEmpresa);
                cmb_tipo_nomina.Properties.DataSource = List_NominaTipo;
                cmb_servicios.EditValue = 3;
                cmb_tipo_nomina.EditValue = 1;
                int IdTipoServicio = cmb_tipo_nomina.EditValue == null ? 0 : Convert.ToInt32(cmb_servicios.EditValue);
                Bind_Lista_Calculo = new BindingList<ro_Calculo_Pago_Variable_Porcentaje_servicio_Info>(Bus_Calculo.get_lis(param.IdEmpresa, Convert.ToInt32(cmb_tipo_nomina.EditValue), IdTipoServicio));
