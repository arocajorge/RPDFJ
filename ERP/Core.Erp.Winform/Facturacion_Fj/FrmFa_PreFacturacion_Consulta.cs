...
namespace Core.Erp.Winform.Facturacion_Fj
{
    public partial class FrmFa_PreFacturacion_Consulta : Form
    {
        ...
        private void Llamar_Formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                frmFa_PreFacturacion_Mantenimiento frm = new frmFa_PreFacturacion_Mantenimiento();
                ...
                frm.event_delegate_frmFa_PreFacturacion_Mantenimiento_FormClosed += frm_event_delegate_frmFa_PreFacturacion_Mantenimiento_FormClosed;
                frm.Show();
            }
            catch (Exception ex)    
            {
        ...
        void frm_event_delegate_frmFa_PreFacturacion_Mantenimiento_FormClosed(object sender, FormClosedEventArgs e)
        {
            Buscar();
        }
