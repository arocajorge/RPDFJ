...
{
    public partial class frmfa_pre_facturacion_servisndustria_Mant : Form
    {
        ...
        List<fa_pre_facturacion_mano_obra_servindustria_Info> lista_mano_obra = new List<fa_pre_facturacion_mano_obra_servindustria_Info>();
        ...
        private void set_info_in_controls()
        {
            try
            {
                ...
                lista_mano_obra = bus_mano_obra.GetList(info_prefacturacion.IdEmpresa,Convert.ToInt32( info_prefacturacion.IdPeriodo));
        ...
        public frmfa_pre_facturacion_servisndustria_Mant()
        {
            InitializeComponent();
        }
        ...
        private bool Guardar()
        {
            try
            {
                ...
                {
                    if (bus_mano_obra.GuardarDB(lista_mano_obra))
                    {
