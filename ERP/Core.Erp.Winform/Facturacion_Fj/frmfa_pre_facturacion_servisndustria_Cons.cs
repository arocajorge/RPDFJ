...
{
    public partial class frmfa_pre_facturacion_servisndustria_Cons : Form
    {
        #region Variables
        ...
        public frmfa_pre_facturacion_servisndustria_Cons()
        {
            InitializeComponent();
        }
        ...
        private void llamar_formulario(Cl_Enumeradores.eTipo_action ACCION)
        {
            try
            {
                frmfa_pre_facturacion_servisndustria_Mant frm = new frmfa_pre_facturacion_servisndustria_Mant();
        ...
        private void frmfa_pre_facturacion_servisndustria_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                load_data();
