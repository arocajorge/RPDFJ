...
{
    public partial class FrmFa_PreFacturacion_Proyeccion_Mano_Obra_Cons : Form
    {
        #region Variables
        ...
        public FrmFa_PreFacturacion_Proyeccion_Mano_Obra_Cons()
        {
            InitializeComponent();
        ...
        private void Llamar_Formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                FrmFa_PreFacturacion_Proyeccion_Mano_Obra_Mant frm = new FrmFa_PreFacturacion_Proyeccion_Mano_Obra_Mant();
        ...
        private void FrmFa_PreFacturacion_Proyeccion_Mano_Obra_Consulta_Load(object sender, EventArgs e)
        {
            try
            {
                Buscar();
