...
{
    public partial class frmfa_pre_facturacion_det_gastos_Cons : Form
    {
        #region Variables
        ...
        public frmfa_pre_facturacion_det_gastos_Cons()
        {
            InitializeComponent();
        }
        ...
        private void load_data()
        {
            try
            {
                lst_prefacturacion = bus_prefacturacion.Get_List(param.IdEmpresa, ucGe_Menu_Mantenimiento_x_usuario1.fecha_desde, ucGe_Menu_Mantenimiento_x_usuario1.fecha_hasta);
                gridControlPrefacturacion.DataSource = lst_prefacturacion;
            }
            catch (Exception ex)
            {
        ...
        private void llamar_formulario(Cl_Enumeradores.eTipo_action ACCION)
        {
            try
            {
                frmfa_pre_facturacion_det_gastos_Mant frm = new frmfa_pre_facturacion_det_gastos_Mant();
                frm.set_accion(ACCION);
                frm.set_info(info_prefacturacion);
                frm.MdiParent = this.MdiParent;
                frm.event_delegate_frmfa_pre_facturacion_det_gastos_Mant_FormClosed+=frm_event_delegate_frmfa_pre_facturacion_det_gastos_Mant_FormClosed;                
                frm.Show();
            }
            catch (Exception ex)
            {
        ...
        void frm_event_delegate_frmfa_pre_facturacion_det_gastos_Mant_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                load_data();
        ...
        private void frmfa_pre_facturacion_det_gastos_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                load_data();
