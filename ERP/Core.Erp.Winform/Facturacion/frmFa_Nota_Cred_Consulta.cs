...
{
    public partial class frmFa_Nota_Cred_Consulta : Form
    {
        ...
        Core.Erp.Business.Facturacion.fa_notaCredDeb_Bus Bus_Nota = new Core.Erp.Business.Facturacion.fa_notaCredDeb_Bus();
        List<fa_notaCreDeb_Info> Lst_nota = new List<fa_notaCreDeb_Info>();
        #endregion

        #region " Constructor"
        public frmFa_Nota_Cred_Consulta()
        {
            InitializeComponent();
        ...
        private void llama_frm(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                ...
                frmFa_Nota_Cred_Mant frm = new frmFa_Nota_Cred_Mant();
        ...
        private void LlenarGrid()
        {
            try
            {
                Lst_nota = Bus_Nota.Get_List_notaCreDeb(param.IdEmpresa, ucGe_Menu_Mantenimiento_x_usuario.getIdSucursal, ucGe_Menu_Mantenimiento_x_usuario.getIdSucursal
                                                            ...
                                                            , ucGe_Menu_Mantenimiento_x_usuario.fecha_desde, ucGe_Menu_Mantenimiento_x_usuario.fecha_hasta, "C");
