...
{
    public partial class frmProd_Gestion_Prod_Lamin_Mant : Form
    {
        public frmProd_Gestion_Prod_Lamin_Mant()
        {
            try
            {
                InitializeComponent();
        ...
        private void frmProd_Diaria_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbMateriaPrima.Properties.DataSource = _Produ_B.Get_list_MateriaPrima_X_ModeloDeProduccion(param.IdEmpresa,1);
                var ProdTerminados = _Produ_B.Get_ProductoTerminado_X_ModeloDeProduccion(param.IdEmpresa,1);
                ...
                cmbJefeTurno.Properties.DataSource = _Role_Bus.Get_List_Empleado_(param.IdEmpresa);
        ...
        private void txtCarga_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (cmbMateriaPrima.EditValue != null)
                {
                    ...
                    //txtProducto.EditValue = Math.Round(((Peso.pr_peso == null ? 0 : Convert.ToDouble(Peso.pr_peso)) * Convert.ToDouble(txtCarga.EditValue)), 2);
                }
            }
            catch (Exception ex)
            {
        ...
        private void txtUnidadesPro1_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (cmbProducto.EditValue != null)
                {
                    ...
                    //txtValorprod1.EditValue = Math.Round(((Peso.pr_peso == null ? 0 : Convert.ToDouble(Peso.pr_peso)) * Convert.ToDouble(txtUnidadesPro1.EditValue)), 2);
                }
            }
            catch (Exception ex)
            {  
        ...
        private void txtUnidadesPro2_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (cmbProduct2.EditValue != null)
                {
                    ...
                    //txtValorProd2.EditValue = Math.Round(((Peso.pr_peso == null ? 0 : Convert.ToDouble(Peso.pr_peso)) * Convert.ToDouble(txtUnidadesPro2.EditValue)), 2); ;
                }
            }
            catch (Exception ex)
            {
        ...
        public void Guardar() 
        {
            try
            {
                ...
                {  
                    ...
                    _Movi_I.cm_tipo = "-";
                    if (_Movi_B.GrabarDB(_Movi_I, ref Id,ref mensaje_cbte_cble, ref Mensaje))
                    {
                        var Prod1 = _BusPROxBOD.Get_Info_Producto_x_Producto(param.IdEmpresa, Convert.ToInt32(Paramestros_I.IdSucursal_EgrxMateriaPrima), Convert.ToInt32(Paramestros_I.IdBodega_EgrxMateriaPrima), _Info.IdProducto_MateriaPrima);
                    ...
                    if (_Movi_B.GrabarDB(_Movi_I, ref Id,ref mensaje_cbte_cble, ref Mensaje))
                    {
                        ...
                        var Prod1 = _BusPROxBOD.Get_Info_Producto_x_Producto(param.IdEmpresa, Paramestros_I.IdSucursal_IngxProduc, Paramestros_I.IdBodega_IngxProduc, _Info.IdProducto_Producido1);
                        var Prod2 = _BusPROxBOD.Get_Info_Producto_x_Producto(param.IdEmpresa, Paramestros_I.IdSucursal_IngxProduc, Paramestros_I.IdBodega_IngxProduc, _Info.IdProducto_Producido2);
                        in_movi_inve_detalle_Info Obj = new in_movi_inve_detalle_Info();
        ...
        void Set() 
        {
            try
            {
                ...
                in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus Bus = new Business.Inventario.in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus();
                gridControl.DataSource = _Detalle_B.Get_List_GestionProductivaLaminado_x_paradas_CusTalme(param.IdEmpresa, _SetInfo.IdGestionProductiva);
                var Info = Bus.Get_Info_moviInventario_x_GestionProdLaminados_Cus_Talme(param.IdEmpresa, _SetInfo.IdGestionProductiva);
                if (Info != null)
                {

                    var Datasourcer = _Movi_B.Get_list_Movi_inven_x_ProdDiariaLagminadosTalme(param.IdEmpresa, Info.mov_IdSucursal, Info.mov_IdBodega, Info.mov_IdMovi_inven_tipo, Info.mov_IdNumMovi);
                ...
                Movimientos.Add(BusDeta.Get_Info_moviInventario_x_GestionProdLaminados_Cus_Talme(param.IdEmpresa,_SetInfo.IdGestionProductiva));
                ...
                {
                    var Movi = _Movi_B.Get_Info_Movi_inven_Report(item.mov_IdEmpresa, item.mov_IdSucursal, item.mov_IdBodega, item.mov_IdMovi_inven_tipo, item.mov_IdNumMovi);
        ...
        private void btnAnular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Bus.Anular(_Info.IdEmpresa, _Info.IdGestionProductiva))
                {
                    ...
                    in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus Bus = new Business.Inventario.in_moviInventario_x_GestionProdLaminados_Cus_Talme_Bus();
                    var Info = Bus.Get_Info_moviInventario_x_GestionProdLaminados_Cus_Talme(param.IdEmpresa, _Info.IdGestionProductiva);
                    if (Info != null)
                    {
                        var Movi = _Movi_B.Get_Info_Movi_inven_Report(Info.mov_IdEmpresa, Info.mov_IdSucursal, Info.mov_IdBodega, Info.mov_IdMovi_inven_tipo, Info.mov_IdNumMovi);
                        if (_Movi_B.AnularDB(Movi,Convert.ToDateTime(DateTime.Now.ToShortDateString()), ref men))
                        {
        ...
        private void gridView5_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
                if (e.Column.Caption == "...")
                {
                    ...
                    DataMoviInven = MoviB.Get_Info_Movi_inven_Report(param.IdEmpresa, Info.mov_IdSucursal, Info.mov_IdBodega, Info.mov_IdMovi_inven_tipo, Info.mov_IdNumMovi);
                    //_Produ_B.Des_Producto
                    DataMoviInven.listmovi_inve_detalle_Info.ForEach(var => { var.NomProducto = _Produ_B.Get_Descripcion_Producto(param.IdEmpresa, var.IdProducto); var.CodProducto = _Produ_B.Get_Codigo_Producto(param.IdEmpresa, var.IdProducto); });
                ...
                if (e.Column.Caption == "*")
                    {
                        ...
                        foreach (var item in Movimientos)
                        {
                            DataMoviInven = MoviB.Get_Info_Movi_inven_Report(param.IdEmpresa, item.mov_IdSucursal, item.mov_IdBodega, item.mov_IdMovi_inven_tipo, item.mov_IdNumMovi);
                            listMoviIn.Add(DataMoviInven);
                        }
