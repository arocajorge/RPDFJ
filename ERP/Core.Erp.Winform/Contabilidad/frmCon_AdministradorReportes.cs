...
{
    public partial class frmCon_AdministradorReportes : Form
    {
        #region Variables
        ...
        public frmCon_AdministradorReportes()
        {
            InitializeComponent();
        }

        private void frmCon_AdministradorReportes_Load(object sender, EventArgs e)
        {
            try
            {
                lstModulo = busModulo.Get_list_Modulo("CONTA");
