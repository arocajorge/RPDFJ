...
{
    public partial class frmCon_CentroCosto_SubCentroCosto_Mant_FJ : Form
    {
        ...
        public frmCon_CentroCosto_SubCentroCosto_Mant_FJ()
        {
            try
            {
                InitializeComponent();
                ...
                frmHandler.ucaF_Activo_Fijo1 = this.ucaF_Activo_Fijo1;
                frmHandler.txtvalor_depreciar = this.txtvalor_depreciar;
        ...
        private void frmCon_CentroCosto_SubCentroCosto_Mant_FJ_Load(object sender, EventArgs e)
        {
            try
            {
