...
{
    public partial class XINV_NAT_Rpt005_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        List<XINV_NAT_Rpt005_Info> lst_reporte = new List<XINV_NAT_Rpt005_Info>();
        XINV_NAT_Rpt005_Bus bus_reporte = new XINV_NAT_Rpt005_Bus();
        List<int> lst_bodega = new List<int>();
        List<string> lst_subcentro = new List<string>();

        public XINV_NAT_Rpt005_Rpt()
        {
            InitializeComponent();
        }
        ...
        private void XINV_NAT_Rpt005_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
