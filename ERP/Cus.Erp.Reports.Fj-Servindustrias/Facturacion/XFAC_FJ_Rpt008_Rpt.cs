...
{
    public partial class XFAC_FJ_Rpt008_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        List<XFAC_FJ_Rpt008_Info> lista = new List<XFAC_FJ_Rpt008_Info>();
        XFAC_FJ_Rpt008_Bus bus = new XFAC_FJ_Rpt008_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XFAC_FJ_Rpt008_Rpt()
        {
            InitializeComponent();
        }

        private void XFAC_FJ_Rpt008_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                decimal IdTransportista = Convert.ToDecimal(p_IdTransportista.Value);
                ...
                lista = bus.get_list(param.IdEmpresa, IdCliente, IdVendedor, IdTransportista, IdPunto_cargo, Fecha_ini, Fecha_fin);
