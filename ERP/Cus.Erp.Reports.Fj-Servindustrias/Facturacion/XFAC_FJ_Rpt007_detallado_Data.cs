...
{
    public class XFAC_FJ_Rpt007_detallado_Data
    {
        public List<XFAC_FJ_Rpt007_detallado_Info> get_list(int IdEmpresa, int IdPeriodo)
        {
            try
            {
                ...
                {
                    Lista = (from q in Context.spFAC_FJ_Rpt007_detallado(IdEmpresa,IdPeriodo)
                             where q.IdEmpresa == IdEmpresa
                             && q.IdPeriodo == IdPeriodo
                             select new XFAC_FJ_Rpt007_detallado_Info
                             {
