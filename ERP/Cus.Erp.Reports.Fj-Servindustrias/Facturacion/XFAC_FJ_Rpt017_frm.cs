...
{
    public partial class XFAC_FJ_Rpt017_frm : Form
    {
        public XFAC_FJ_Rpt017_frm()
        {
            InitializeComponent();
        }
        ...
        private void ucFa_Menu_Reportes1_event_btnConsultar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                XFAC_FJ_Rpt017_Rpt rpt = new XFAC_FJ_Rpt017_Rpt();
                ...
                rpt.p_no_mostrar_saldo_0.Value = ucFa_Menu_Reportes1.bei_check_1.EditValue == null ? false : Convert.ToBoolean(ucFa_Menu_Reportes1.bei_check_1.EditValue);
