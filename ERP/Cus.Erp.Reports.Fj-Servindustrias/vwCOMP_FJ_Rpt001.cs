...
namespace Cus.Erp.Reports.FJ
{
    ...
    public partial class vwCOMP_FJ_Rpt001
    {
        ...
        public string Direccion_sucu { get; set; }
        public string Telef_Sucursal { get; set; }
        public string Contacto_Prov { get; set; }
        public string mail_prove { get; set; }
