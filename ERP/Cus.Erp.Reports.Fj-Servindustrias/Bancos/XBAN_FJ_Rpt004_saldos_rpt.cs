...
{
    public partial class XBAN_FJ_Rpt004_saldos_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        List<XBAN_FJ_Rpt004_saldos_Info> lstInfo = new List<XBAN_FJ_Rpt004_saldos_Info>();
        string _tipo_saldo = "";

        public XBAN_FJ_Rpt004_saldos_rpt()
        {
            InitializeComponent();
        }

        public void set_parametros(string tipo_saldo, List<XBAN_FJ_Rpt004_saldos_Info> lista)
        {
            try
            {
                lstInfo = lista;
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XBAN_FJ_Rpt004_saldos_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XBAN_FJ_Rpt004_saldos_rpt) };
            }
        }
        ...
        private void XBAN_FJ_Rpt004_saldos_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
