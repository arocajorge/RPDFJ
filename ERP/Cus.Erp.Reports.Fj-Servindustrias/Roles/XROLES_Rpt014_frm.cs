...
{
    public partial class XROLES_Rpt014_frm : Form
    {
        public XROLES_Rpt014_frm()
        {
            InitializeComponent();
        }
        ...
        XROLES_Rpt014_Bus bus = new XROLES_Rpt014_Bus();
        ...
        private void GenerarReporte()
        {
            try
            {
                XROLES_Rpt014_Rpt Reporte = new XROLES_Rpt014_Rpt();
