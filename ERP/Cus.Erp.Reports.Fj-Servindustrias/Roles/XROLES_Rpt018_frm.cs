...
{
    public partial class XROLES_Rpt018_frm : Form
    {
        public XROLES_Rpt018_frm()
        {
            InitializeComponent();
        }
        ...
        XROLES_Rpt018_Bus bus = new XROLES_Rpt018_Bus();
        ...
        private void GenerarReporte()
        {
            try
            {
                XROLES_Rpt018_Rpt Reporte = new XROLES_Rpt018_Rpt();
