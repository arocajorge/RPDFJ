...
namespace Cus.Erp.Reports.FJ.Roles
{
    public partial class XROLES_Rpt005_frm : Form
    {
        ...
        private void XROLES_Rpt005_frm_Load(object sender, EventArgs e)
        {
            try
            {
            }
