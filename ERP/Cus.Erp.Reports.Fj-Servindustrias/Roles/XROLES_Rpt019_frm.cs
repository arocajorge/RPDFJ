...
{
    public partial class XROLES_Rpt019_frm : Form
    {
        public XROLES_Rpt019_frm()
        {
            InitializeComponent();
        }
        ...
        XROLES_Rpt019_Bus bus = new XROLES_Rpt019_Bus();
        ...
        private void GenerarReporte()
        {
            try
            {
                XROLES_Rpt019_Rpt Reporte = new XROLES_Rpt019_Rpt();
