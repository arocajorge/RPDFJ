...
{
    public partial class XROLES_Rpt016_frm : Form
    {
        public XROLES_Rpt016_frm()
        {
            InitializeComponent();
        }
        ...
        XROLES_Rpt016_Bus bus = new XROLES_Rpt016_Bus();
        ...
        private void GenerarReporte()
        {
            try
            {
                XROLES_Rpt016_Rpt Reporte = new XROLES_Rpt016_Rpt();
                ...
                Reporte.Parameters["idnominatipo"].Value = ucRo_Menu.getIdNominaTipoLiqui();
                Reporte.Parameters["idperiodo"].Value = ucRo_Menu.getIdPeriodo();

                Reporte.Parameters["fechai"].Value = info_perio.pe_FechaIni;
                Reporte.Parameters["fechaf"].Value = info_perio.pe_FechaFin;
                Reporte.ShowPreview();
