...
namespace Cus.Erp.Reports.FJ.Roles
{
    public partial class XROLES_Rpt011_frm : Form
    {
        ...
        private void XROLES_Rpt011_frm_Load(object sender, EventArgs e)
        {
            try
            {
            }
